...
const appCss = "/assets/styles-OkVnAk7Y.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "NOCTURNE — A New Era of Nightlife" },
      { name: "description", content: "An after-dark members club. Crafted for the night." },
      { property: "og:title", content: "NOCTURNE — A New Era of Nightlife" },
      { property: "og:description", content: "Drinks. Music. Energy. Reservations open." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Fraunces:ital,opsz,wght@0,9..144,300;1,9..144,300&family=Inter:wght@300;400;500&family=JetBrains+Mono:wght@400&display=swap"
      }
    ]
  }),
    ...
    /* @__PURE__ */ jsx(
      "header",
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "mx-auto flex items-center justify-between px-5 md:px-10 h-16 md:h-20", children: [
          /* @__PURE__ */ jsxs("a", { href: "#top", className: "font-display text-xl md:text-2xl tracking-[0.18em] text-bone", children: [
            "NOCTURNE",
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
            /* @__PURE__ */ jsx("a", { href: "#reserve", className: "hidden md:inline-flex font-mono text-[11px] uppercase tracking-cine text-bone border border-bone/30 px-4 py-2 hover:bg-bone hover:text-ink transition-colors", children: "Reserve" }),
            /* @__PURE__ */ jsxs(
              "button",
              {
                onClick: () => setOpen((v) => !v),
