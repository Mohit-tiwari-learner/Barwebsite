...
`)}const bm={[Po]:"Linear",[No]:"Reinhard",[Do]:"Cineon",[Lo]:"ACESFilmic",[Io]:"AgX",[Fo]:"Neutral",[Uo]:"Custom"};function ym(i,e){const t=bm[e];return t===void 0?(we("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const ss=new H;function Tm(){Ve.getLuminanceCoefficients(ss);const i=ss.x.toFixed(4),e=ss.y.toFixed(4),t=ss.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+h);const T=M+f+a,y=M+h+o,N=po(s,s.VERTEX_SHADER,T),b=po(s,s.FRAGMENT_SHADER,y);s.attachShader(E,N),s.attachShader(E,b),t.index0AttributeName!==void 0?s.bindAttribLocation(E,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(E,0,"position"),s.linkProgram(E);function D(R){if(i.debug.checkShaderErrors){const O=s.getProgramInfoLog(E)||"",X=s.getShaderInfoLog(N)||"",W=s.getShaderInfoLog(b)||"",U=O.trim(),G=X.trim(),V=W.trim();let $=!0,ee=!0;if(s.getProgramParameter(E,s.LINK_STATUS)===!1)if($=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,E,N,b);else{const le=go(s,N,"vertex"),ve=go(s,b,"fragment");Xe("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(E,s.VALIDATE_STATUS)+`
...
Program Info Log: `+U+`
`+le+`
`+ve)}else U!==""?we("WebGLProgram: Program Info Log:",U):(G===""||V==="")&&(ee=!1);ee&&(R.diagnostics={runnable:$,programLog:U,vertexShader:{log:G,prefix:f},fragmentShader:{log:V,prefix:h}})}s.deleteShader(N),s.deleteShader(b),v=new hs(s,E),A=Rm(s,E)}let v;this.getUniforms=function(){return v===void 0&&D(this),v};let A;this.getAttributes=function(){return A===void 0&&D(this),A};let I=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return I===!1&&(I=s.getProgramParameter(E,xm)),I},this.destroy=function(){n.releaseStatesOfProgram(this),s.deleteProgram(E),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=vm++,this.cacheKey=e,this.usedTimes=1,this.program=E,this.vertexShader=N,this.fragmentShader=b,this}let Wm=0;class Xm{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,s=this._getShaderStage(t),r=this._getShaderStage(n),a=this._getShaderCacheForMaterial(e);return a.has(s)===!1&&(a.add(s),s.usedTimes++),a.has(r)===!1&&(a.add(r),r.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new jm(e),t.set(e,n)),n}}class jm{constructor(e){this.id=Wm++,this.code=e,this.usedTimes=0}}function qm(i){return i===Vn||i===ds||i===fs}function Ym(i,e,t,n,s,r){const a=new qo,o=new Xm,l=new Set,c=[],d=new Map,p=n.logarithmicDepthBuffer;let u=n.precision;const m={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(v){return l.add(v),v===0?"uv":`uv${v}`}function E(v,A,I,R,O,X){const W=R.fog,U=O.geometry,G=v.isMeshStandardMaterial||v.isMeshLambertMaterial||v.isMeshPhongMaterial?R.environment:null,V=v.isMeshStandardMaterial||v.isMeshLambertMaterial&&!v.envMap||v.isMeshPhongMaterial&&!v.envMap,$=e.get(v.envMap||G,V),ee=$&&$.mapping===vs?$.image.height:null,le=m[v.type];v.precision!==null&&(u=n.getMaxPrecision(v.precision),u!==v.precision&&we("WebGLProgram.getParameters:",v.precision,"not supported, using",u,"instead."));const ve=U.morphAttributes.position||U.morphAttributes.normal||U.morphAttributes.color,Me=ve!==void 0?ve.length:0;let He=0;U.morphAttributes.position!==void 0&&(He=1),U.morphAttributes.normal!==void 0&&(He=2),U.morphAttributes.color!==void 0&&(He=3);let Ge,Pe,K,ce;if(le){const De=$t[le];Ge=De.vertexShader,Pe=De.fragmentShader}else Ge=v.vertexShader,Pe=v.fragmentShader,o.update(v),K=o.getVertexShaderID(v),ce=o.getFragmentShaderID(v);const te=i.getRenderTarget(),Te=i.state.buffers.depth.getReversed(),Re=O.isInstancedMesh===!0,Ae=O.isBatchedMesh===!0,Je=!!v.map,ze=!!v.matcap,Ye=!!$,Qe=!!v.aoMap,Oe=!!v.lightMap,ut=!!v.bumpMap,at=!!v.normalMap,At=!!v.displacementMap,P=!!v.emissiveMap,ot=!!v.metalnessMap,Ie=!!v.roughnessMap,Ke=v.anisotropy>0,ue=v.clearcoat>0,lt=v.dispersion>0,S=v.iridescence>0,g=v.sheen>0,F=v.transmission>0,Y=Ke&&!!v.anisotropyMap,Q=ue&&!!v.clearcoatMap,ne=ue&&!!v.clearcoatNormalMap,oe=ue&&!!v.clearcoatRoughnessMap,j=S&&!!v.iridescenceMap,Z=S&&!!v.iridescenceThicknessMap,pe=g&&!!v.sheenColorMap,_e=g&&!!v.sheenRoughnessMap,re=!!v.specularMap,ie=!!v.specularColorMap,Ce=!!v.specularIntensityMap,Ue=F&&!!v.transmissionMap,je=F&&!!v.thicknessMap,C=!!v.gradientMap,se=!!v.alphaMap,q=v.alphaTest>0,me=!!v.alphaHash,ae=!!v.extensions;let J=en;v.toneMapped&&(te===null||te.isXRRenderTarget===!0)&&(J=i.toneMapping);const Ee={shaderID:le,shaderType:v.type,shaderName:v.name,vertexShader:Ge,fragmentShader:Pe,defines:v.defines,customVertexShaderID:K,customFragmentShaderID:ce,isRawShaderMaterial:v.isRawShaderMaterial===!0,glslVersion:v.glslVersion,precision:u,batching:Ae,batchingColor:Ae&&O._colorsTexture!==null,instancing:Re,instancingColor:Re&&O.instanceColor!==null,instancingMorph:Re&&O.morphTexture!==null,outputColorSpace:te===null?i.outputColorSpace:te.isXRRenderTarget===!0?te.texture.colorSpace:Ve.workingColorSpace,alphaToCoverage:!!v.alphaToCoverage,map:Je,matcap:ze,envMap:Ye,envMapMode:Ye&&$.mapping,envMapCubeUVHeight:ee,aoMap:Qe,lightMap:Oe,bumpMap:ut,normalMap:at,displacementMap:At,emissiveMap:P,normalMapObjectSpace:at&&v.normalMapType===Du,normalMapTangentSpace:at&&v.normalMapType===Ra,packedNormalMap:at&&v.normalMapType===Ra&&qm(v.normalMap.format),metalnessMap:ot,roughnessMap:Ie,anisotropy:Ke,anisotropyMap:Y,clearcoat:ue,clearcoatMap:Q,clearcoatNormalMap:ne,clearcoatRoughnessMap:oe,dispersion:lt,iridescence:S,iridescenceMap:j,iridescenceThicknessMap:Z,sheen:g,sheenColorMap:pe,sheenRoughnessMap:_e,specularMap:re,specularColorMap:ie,specularIntensityMap:Ce,transmission:F,transmissionMap:Ue,thicknessMap:je,gradientMap:C,opaque:v.transparent===!1&&v.blending===li&&v.alphaToCoverage===!1,alphaMap:se,alphaTest:q,alphaHash:me,combine:v.combine,mapUv:Je&&_(v.map.channel),aoMapUv:Qe&&_(v.aoMap.channel),lightMapUv:Oe&&_(v.lightMap.channel),bumpMapUv:ut&&_(v.bumpMap.channel),normalMapUv:at&&_(v.normalMap.channel),displacementMapUv:At&&_(v.displacementMap.channel),emissiveMapUv:P&&_(v.emissiveMap.channel),metalnessMapUv:ot&&_(v.metalnessMap.channel),roughnessMapUv:Ie&&_(v.roughnessMap.channel),anisotropyMapUv:Y&&_(v.anisotropyMap.channel),clearcoatMapUv:Q&&_(v.clearcoatMap.channel),clearcoatNormalMapUv:ne&&_(v.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:oe&&_(v.clearcoatRoughnessMap.channel),iridescenceMapUv:j&&_(v.iridescenceMap.channel),iridescenceThicknessMapUv:Z&&_(v.iridescenceThicknessMap.channel),sheenColorMapUv:pe&&_(v.sheenColorMap.channel),sheenRoughnessMapUv:_e&&_(v.sheenRoughnessMap.channel),specularMapUv:re&&_(v.specularMap.channel),specularColorMapUv:ie&&_(v.specularColorMap.channel),specularIntensityMapUv:Ce&&_(v.specularIntensityMap.channel),transmissionMapUv:Ue&&_(v.transmissionMap.channel),thicknessMapUv:je&&_(v.thicknessMap.channel),alphaMapUv:se&&_(v.alphaMap.channel),vertexTangents:!!U.attributes.tangent&&(at||Ke),vertexNormals:!!U.attributes.normal,vertexColors:v.vertexColors,vertexAlphas:v.vertexColors===!0&&!!U.attributes.color&&U.attributes.color.itemSize===4,pointsUvs:O.isPoints===!0&&!!U.attributes.uv&&(Je||se),fog:!!W,useFog:v.fog===!0,fogExp2:!!W&&W.isFogExp2,flatShading:v.wireframe===!1&&(v.flatShading===!0||U.attributes.normal===void 0&&at===!1&&(v.isMeshLambertMaterial||v.isMeshPhongMaterial||v.isMeshStandardMaterial||v.isMeshPhysicalMaterial)),sizeAttenuation:v.sizeAttenuation===!0,logarithmicDepthBuffer:p,reversedDepthBuffer:Te,skinning:O.isSkinnedMesh===!0,morphTargets:U.morphAttributes.position!==void 0,morphNormals:U.morphAttributes.normal!==void 0,morphColors:U.morphAttributes.color!==void 0,morphTargetsCount:Me,morphTextureStride:He,numDirLights:A.directional.length,numPointLights:A.point.length,numSpotLights:A.spot.length,numSpotLightMaps:A.spotLightMap.length,numRectAreaLights:A.rectArea.length,numHemiLights:A.hemi.length,numDirLightShadows:A.directionalShadowMap.length,numPointLightShadows:A.pointShadowMap.length,numSpotLightShadows:A.spotShadowMap.length,numSpotLightShadowsWithMaps:A.numSpotLightShadowsWithMaps,numLightProbes:A.numLightProbes,numLightProbeGrids:X.length,numClippingPlanes:r.numPlanes,numClipIntersection:r.numIntersection,dithering:v.dithering,shadowMapEnabled:i.shadowMap.enabled&&I.length>0,shadowMapType:i.shadowMap.type,toneMapping:J,decodeVideoTexture:Je&&v.map.isVideoTexture===!0&&Ve.getTransfer(v.map.colorSpace)===Ze,decodeVideoTextureEmissive:P&&v.emissiveMap.isVideoTexture===!0&&Ve.getTransfer(v.emissiveMap.colorSpace)===Ze,premultipliedAlpha:v.premultipliedAlpha,doubleSided:v.side===un,flipSided:v.side===Pt,useDepthPacking:v.depthPacking>=0,depthPacking:v.depthPacking||0,index0AttributeName:v.index0AttributeName,extensionClipCullDistance:ae&&v.extensions.clipCullDistance===!0&&t.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(ae&&v.extensions.multiDraw===!0||Ae)&&t.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:t.has("KHR_parallel_shader_compile"),customProgramCacheKey:v.customProgramCacheKey()};return Ee.vertexUv1s=l.has(1),Ee.vertexUv2s=l.has(2),Ee.vertexUv3s=l.has(3),l.clear(),Ee}function f(v){const A=[];if(v.shaderID?A.push(v.shaderID):(A.push(v.customVertexShaderID),A.push(v.customFragmentShaderID)),v.defines!==void 0)for(const I in v.defines)A.push(I),A.push(v.defines[I]);return v.isRawShaderMaterial===!1&&(h(A,v),M(A,v),A.push(i.outputColorSpace)),A.push(v.customProgramCacheKey),A.join()}function h(v,A){v.push(A.precision),v.push(A.outputColorSpace),v.push(A.envMapMode),v.push(A.envMapCubeUVHeight),v.push(A.mapUv),v.push(A.alphaMapUv),v.push(A.lightMapUv),v.push(A.aoMapUv),v.push(A.bumpMapUv),v.push(A.normalMapUv),v.push(A.displacementMapUv),v.push(A.emissiveMapUv),v.push(A.metalnessMapUv),v.push(A.roughnessMapUv),v.push(A.anisotropyMapUv),v.push(A.clearcoatMapUv),v.push(A.clearcoatNormalMapUv),v.push(A.clearcoatRoughnessMapUv),v.push(A.iridescenceMapUv),v.push(A.iridescenceThicknessMapUv),v.push(A.sheenColorMapUv),v.push(A.sheenRoughnessMapUv),v.push(A.specularMapUv),v.push(A.specularColorMapUv),v.push(A.specularIntensityMapUv),v.push(A.transmissionMapUv),v.push(A.thicknessMapUv),v.push(A.combine),v.push(A.fogExp2),v.push(A.sizeAttenuation),v.push(A.morphTargetsCount),v.push(A.morphAttributeCount),v.push(A.numDirLights),v.push(A.numPointLights),v.push(A.numSpotLights),v.push(A.numSpotLightMaps),v.push(A.numHemiLights),v.push(A.numRectAreaLights),v.push(A.numDirLightShadows),v.push(A.numPointLightShadows),v.push(A.numSpotLightShadows),v.push(A.numSpotLightShadowsWithMaps),v.push(A.numLightProbes),v.push(A.shadowMapType),v.push(A.toneMapping),v.push(A.numClippingPlanes),v.push(A.numClipIntersection),v.push(A.depthPacking)}function M(v,A){a.disableAll(),A.instancing&&a.enable(0),A.instancingColor&&a.enable(1),A.instancingMorph&&a.enable(2),A.matcap&&a.enable(3),A.envMap&&a.enable(4),A.normalMapObjectSpace&&a.enable(5),A.normalMapTangentSpace&&a.enable(6),A.clearcoat&&a.enable(7),A.iridescence&&a.enable(8),A.alphaTest&&a.enable(9),A.vertexColors&&a.enable(10),A.vertexAlphas&&a.enable(11),A.vertexUv1s&&a.enable(12),A.vertexUv2s&&a.enable(13),A.vertexUv3s&&a.enable(14),A.vertexTangents&&a.enable(15),A.anisotropy&&a.enable(16),A.alphaHash&&a.enable(17),A.batching&&a.enable(18),A.dispersion&&a.enable(19),A.batchingColor&&a.enable(20),A.gradientMap&&a.enable(21),A.packedNormalMap&&a.enable(22),A.vertexNormals&&a.enable(23),v.push(a.mask),a.disableAll(),A.fog&&a.enable(0),A.useFog&&a.enable(1),A.flatShading&&a.enable(2),A.logarithmicDepthBuffer&&a.enable(3),A.reversedDepthBuffer&&a.enable(4),A.skinning&&a.enable(5),A.morphTargets&&a.enable(6),A.morphNormals&&a.enable(7),A.morphColors&&a.enable(8),A.premultipliedAlpha&&a.enable(9),A.shadowMapEnabled&&a.enable(10),A.doubleSided&&a.enable(11),A.flipSided&&a.enable(12),A.useDepthPacking&&a.enable(13),A.dithering&&a.enable(14),A.transmission&&a.enable(15),A.sheen&&a.enable(16),A.opaque&&a.enable(17),A.pointsUvs&&a.enable(18),A.decodeVideoTexture&&a.enable(19),A.decodeVideoTextureEmissive&&a.enable(20),A.alphaToCoverage&&a.enable(21),A.numLightProbeGrids>0&&a.enable(22),v.push(a.mask)}function T(v){const A=m[v.type];let I;if(A){const R=$t[A];I=_h.clone(R.uniforms)}else I=v.uniforms;return I}function y(v,A){let I=d.get(A);return I!==void 0?++I.usedTimes:(I=new km(i,A,v,s),c.push(I),d.set(A,I)),I}function N(v){if(--v.usedTimes===0){const A=c.indexOf(v);c[A]=c[c.length-1],c.pop(),d.delete(v.cacheKey),v.destroy()}}function b(v){o.remove(v)}function D(){o.dispose()}return{getParameters:E,getProgramCacheKey:f,getUniforms:T,acquireProgram:y,releaseProgram:N,releaseShaderCache:b,programs:c,dispose:D}}function Km(){let i=new WeakMap;function e(a){return i.has(a)}function t(a){let o=i.get(a);return o===void 0&&(o={},i.set(a,o)),o}function n(a){i.delete(a)}function s(a,o,l){i.get(a)[o]=l}function r(){i=new WeakMap}return{has:e,get:t,remove:n,update:s,dispose:r}}function Zm(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.materialVariant!==e.materialVariant?i.materialVariant-e.materialVariant:i.z!==e.z?i.z-e.z:i.id-e.id}function Mo(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function Eo(){const i=[];let e=0;const t=[],n=[],s=[];function r(){e=0,t.length=0,n.length=0,s.length=0}function a(u){let m=0;return u.isInstancedMesh&&(m+=2),u.isSkinnedMesh&&(m+=1),m}function o(u,m,_,E,f,h){let M=i[e];return M===void 0?(M={id:u.id,object:u,geometry:m,material:_,materialVariant:a(u),groupOrder:E,renderOrder:u.renderOrder,z:f,group:h},i[e]=M):(M.id=u.id,M.object=u,M.geometry=m,M.material=_,M.materialVariant=a(u),M.groupOrder=E,M.renderOrder=u.renderOrder,M.z=f,M.group=h),e++,M}function l(u,m,_,E,f,h){const M=o(u,m,_,E,f,h);_.transmission>0?n.push(M):_.transparent===!0?s.push(M):t.push(M)}function c(u,m,_,E,f,h){const M=o(u,m,_,E,f,h);_.transmission>0?n.unshift(M):_.transparent===!0?s.unshift(M):t.unshift(M)}function d(u,m){t.length>1&&t.sort(u||Zm),n.length>1&&n.sort(m||Mo),s.length>1&&s.sort(m||Mo)}function p(){for(let u=e,m=i.length;u<m;u++){const _=i[u];if(_.id===null)break;_.id=null,_.object=null,_.geometry=null,_.material=null,_.group=null}}return{opaque:t,transmissive:n,transparent:s,init:r,push:l,unshift:c,finish:p,sort:d}}function $m(){let i=new WeakMap;function e(n,s){const r=i.get(n);let a;return r===void 0?(a=new Eo,i.set(n,[a])):s>=r.length?(a=new Eo,r.push(a)):a=r[s],a}function t(){i=new WeakMap}return{get:e,dispose:t}}function Jm(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new H,color:new $e};break;case"SpotLight":t={position:new H,direction:new H,color:new $e,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new H,color:new $e,distance:0,decay:0};break;case"HemisphereLight":t={direction:new H,skyColor:new $e,groundColor:new $e};break;case"RectAreaLight":t={color:new $e,position:new H,halfWidth:new H,halfHeight:new H};break}return i[e.id]=t,t}}}function Qm(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new qe};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new qe};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new qe,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}let eg=0;function tg(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function ng(i){const e=new Jm,t=Qm(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new H);const s=new H,r=new gt,a=new gt;function o(c){let d=0,p=0,u=0;for(let A=0;A<9;A++)n.probe[A].set(0,0,0);let m=0,_=0,E=0,f=0,h=0,M=0,T=0,y=0,N=0,b=0,D=0;c.sort(tg);for(let A=0,I=c.length;A<I;A++){const R=c[A],O=R.color,X=R.intensity,W=R.distance;let U=null;if(R.shadow&&R.shadow.map&&(R.shadow.map.texture.format===Vn?U=R.shadow.map.texture:U=R.shadow.map.depthTexture||R.shadow.map.texture),R.isAmbientLight)d+=O.r*X,p+=O.g*X,u+=O.b*X;else if(R.isLightProbe){for(let G=0;G<9;G++)n.probe[G].addScaledVector(R.sh.coefficients[G],X);D++}else if(R.isDirectionalLight){const G=e.get(R);if(G.color.copy(R.color).multiplyScalar(R.intensity),R.castShadow){const V=R.shadow,$=t.get(R);$.shadowIntensity=V.intensity,$.shadowBias=V.bias,$.shadowNormalBias=V.normalBias,$.shadowRadius=V.radius,$.shadowMapSize=V.mapSize,n.directionalShadow[m]=$,n.directionalShadowMap[m]=U,n.directionalShadowMatrix[m]=R.shadow.matrix,M++}n.directional[m]=G,m++}else if(R.isSpotLight){const G=e.get(R);G.position.setFromMatrixPosition(R.matrixWorld),G.color.copy(O).multiplyScalar(X),G.distance=W,G.coneCos=Math.cos(R.angle),G.penumbraCos=Math.cos(R.angle*(1-R.penumbra)),G.decay=R.decay,n.spot[E]=G;const V=R.shadow;if(R.map&&(n.spotLightMap[N]=R.map,N++,V.updateMatrices(R),R.castShadow&&b++),n.spotLightMatrix[E]=V.matrix,R.castShadow){const $=t.get(R);$.shadowIntensity=V.intensity,$.shadowBias=V.bias,$.shadowNormalBias=V.normalBias,$.shadowRadius=V.radius,$.shadowMapSize=V.mapSize,n.spotShadow[E]=$,n.spotShadowMap[E]=U,y++}E++}else if(R.isRectAreaLight){const G=e.get(R);G.color.copy(O).multiplyScalar(X),G.halfWidth.set(R.width*.5,0,0),G.halfHeight.set(0,R.height*.5,0),n.rectArea[f]=G,f++}else if(R.isPointLight){const G=e.get(R);if(G.color.copy(R.color).multiplyScalar(R.intensity),G.distance=R.distance,G.decay=R.decay,R.castShadow){const V=R.shadow,$=t.get(R);$.shadowIntensity=V.intensity,$.shadowBias=V.bias,$.shadowNormalBias=V.normalBias,$.shadowRadius=V.radius,$.shadowMapSize=V.mapSize,$.shadowCameraNear=V.camera.near,$.shadowCameraFar=V.camera.far,n.pointShadow[_]=$,n.pointShadowMap[_]=U,n.pointShadowMatrix[_]=R.shadow.matrix,T++}n.point[_]=G,_++}else if(R.isHemisphereLight){const G=e.get(R);G.skyColor.copy(R.color).multiplyScalar(X),G.groundColor.copy(R.groundColor).multiplyScalar(X),n.hemi[h]=G,h++}}f>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=he.LTC_FLOAT_1,n.rectAreaLTC2=he.LTC_FLOAT_2):(n.rectAreaLTC1=he.LTC_HALF_1,n.rectAreaLTC2=he.LTC_HALF_2)),n.ambient[0]=d,n.ambient[1]=p,n.ambient[2]=u;const v=n.hash;(v.directionalLength!==m||v.pointLength!==_||v.spotLength!==E||v.rectAreaLength!==f||v.hemiLength!==h||v.numDirectionalShadows!==M||v.numPointShadows!==T||v.numSpotShadows!==y||v.numSpotMaps!==N||v.numLightProbes!==D)&&(n.directional.length=m,n.spot.length=E,n.rectArea.length=f,n.point.length=_,n.hemi.length=h,n.directionalShadow.length=M,n.directionalShadowMap.length=M,n.pointShadow.length=T,n.pointShadowMap.length=T,n.spotShadow.length=y,n.spotShadowMap.length=y,n.directionalShadowMatrix.length=M,n.pointShadowMatrix.length=T,n.spotLightMatrix.length=y+N-b,n.spotLightMap.length=N,n.numSpotLightShadowsWithMaps=b,n.numLightProbes=D,v.directionalLength=m,v.pointLength=_,v.spotLength=E,v.rectAreaLength=f,v.hemiLength=h,v.numDirectionalShadows=M,v.numPointShadows=T,v.numSpotShadows=y,v.numSpotMaps=N,v.numLightProbes=D,n.version=eg++)}function l(c,d){let p=0,u=0,m=0,_=0,E=0;const f=d.matrixWorldInverse;for(let h=0,M=c.length;h<M;h++){const T=c[h];if(T.isDirectionalLight){const y=n.directional[p];y.direction.setFromMatrixPosition(T.matrixWorld),s.setFromMatrixPosition(T.target.matrixWorld),y.direction.sub(s),y.direction.transformDirection(f),p++}else if(T.isSpotLight){const y=n.spot[m];y.position.setFromMatrixPosition(T.matrixWorld),y.position.applyMatrix4(f),y.direction.setFromMatrixPosition(T.matrixWorld),s.setFromMatrixPosition(T.target.matrixWorld),y.direction.sub(s),y.direction.transformDirection(f),m++}else if(T.isRectAreaLight){const y=n.rectArea[_];y.position.setFromMatrixPosition(T.matrixWorld),y.position.applyMatrix4(f),a.identity(),r.copy(T.matrixWorld),r.premultiply(f),a.extractRotation(r),y.halfWidth.set(T.width*.5,0,0),y.halfHeight.set(0,T.height*.5,0),y.halfWidth.applyMatrix4(a),y.halfHeight.applyMatrix4(a),_++}else if(T.isPointLight){const y=n.point[u];y.position.setFromMatrixPosition(T.matrixWorld),y.position.applyMatrix4(f),u++}else if(T.isHemisphereLight){const y=n.hemi[E];y.direction.setFromMatrixPosition(T.matrixWorld),y.direction.transformDirection(f),E++}}}return{setup:o,setupView:l,state:n}}function bo(i){const e=new ng(i),t=[],n=[],s=[];function r(u){p.camera=u,t.length=0,n.length=0,s.length=0}function a(u){t.push(u)}function o(u){n.push(u)}function l(u){s.push(u)}function c(){e.setup(t)}function d(u){e.setupView(t,u)}const p={lightsArray:t,shadowsArray:n,lightProbeGridArray:s,camera:null,lights:e,transmissionRenderTarget:{},textureUnits:0};return{init:r,state:p,setupLights:c,setupLightsView:d,pushLight:a,pushShadow:o,pushLightProbeGrid:l}}function ig(i){let e=new WeakMap;function t(s,r=0){const a=e.get(s);let o;return a===void 0?(o=new bo(i),e.set(s,[o])):r>=a.length?(o=new bo(i),a.push(o)):o=a[r],o}function n(){e=new WeakMap}return{get:t,dispose:n}}const sg=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,ag=[new H(1,0,0),new H(-1,0,0),new H(0,1,0),new H(0,-1,0),new H(0,0,1),new H(0,0,-1)],og=[new H(0,-1,0),new H(0,-1,0),new H(0,0,1),new H(0,0,-1),new H(0,-1,0),new H(0,-1,0)],yo=new gt,Ei=new H,sr=new H;function lg(i,e,t){let n=new Qo;const s=new qe,r=new qe,a=new pt,o=new Mh,l=new Eh,c={},d=t.maxTextureSize,p={[Pn]:Pt,[Pt]:Pn,[un]:un},u=new Xt({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new qe},radius:{value:4}},vertexShader:sg,fragmentShader:rg}),m=u.clone();m.defines.HORIZONTAL_PASS=1;const _=new jt;_.setAttribute("position",new yt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const E=new _n(_,u),f=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=as;let h=this.type;this.render=function(b,D,v){if(f.enabled===!1||f.autoUpdate===!1&&f.needsUpdate===!1||b.length===0)return;this.type===cu&&(we("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=as);const A=i.getRenderTarget(),I=i.getActiveCubeFace(),R=i.getActiveMipmapLevel(),O=i.state;O.setBlending(dn),O.buffers.depth.getReversed()===!0?O.buffers.color.setClear(0,0,0,0):O.buffers.color.setClear(1,1,1,1),O.buffers.depth.setTest(!0),O.setScissorTest(!1);const X=h!==this.type;X&&D.traverse(function(W){W.material&&(Array.isArray(W.material)?W.material.forEach(U=>U.needsUpdate=!0):W.material.needsUpdate=!0)});for(let W=0,U=b.length;W<U;W++){const G=b[W],V=G.shadow;if(V===void 0){we("WebGLShadowMap:",G,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;s.copy(V.mapSize);const $=V.getFrameExtents();s.multiply($),r.copy(V.mapSize),(s.x>d||s.y>d)&&(s.x>d&&(r.x=Math.floor(d/$.x),s.x=r.x*$.x,V.mapSize.x=r.x),s.y>d&&(r.y=Math.floor(d/$.y),s.y=r.y*$.y,V.mapSize.y=r.y));const ee=i.state.buffers.depth.getReversed();if(V.camera._reversedDepth=ee,V.map===null||X===!0){if(V.map!==null&&(V.map.depthTexture!==null&&(V.map.depthTexture.dispose(),V.map.depthTexture=null),V.map.dispose()),this.type===yi){if(G.isPointLight){we("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}V.map=new tn(s.x,s.y,{format:Vn,type:mn,minFilter:Tt,magFilter:Tt,generateMipmaps:!1}),V.map.texture.name=G.name+".shadowMap",V.map.depthTexture=new di(s.x,s.y,Jt),V.map.depthTexture.name=G.name+".shadowMapDepth",V.map.depthTexture.format=gn,V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=St,V.map.depthTexture.magFilter=St}else G.isPointLight?(V.map=new ol(s.x),V.map.depthTexture=new mh(s.x,nn)):(V.map=new tn(s.x,s.y),V.map.depthTexture=new di(s.x,s.y,nn)),V.map.depthTexture.name=G.name+".shadowMap",V.map.depthTexture.format=gn,this.type===as?(V.map.depthTexture.compareFunction=ee?aa:ra,V.map.depthTexture.minFilter=Tt,V.map.depthTexture.magFilter=Tt):(V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=St,V.map.depthTexture.magFilter=St);V.camera.updateProjectionMatrix()}const le=V.map.isWebGLCubeRenderTarget?6:1;for(let ve=0;ve<le;ve++){if(V.map.isWebGLCubeRenderTarget)i.setRenderTarget(V.map,ve),i.clear();else{ve===0&&(i.setRenderTarget(V.map),i.clear());const Me=V.getViewport(ve);a.set(r.x*Me.x,r.y*Me.y,r.x*Me.z,r.y*Me.w),O.viewport(a)}if(G.isPointLight){const Me=V.camera,He=V.matrix,Ge=G.distance||Me.far;Ge!==Me.far&&(Me.far=Ge,Me.updateProjectionMatrix()),Ei.setFromMatrixPosition(G.matrixWorld),Me.position.copy(Ei),sr.copy(Me.position),sr.add(ag[ve]),Me.up.copy(og[ve]),Me.lookAt(sr),Me.updateMatrixWorld(),He.makeTranslation(-Ei.x,-Ei.y,-Ei.z),yo.multiplyMatrices(Me.projectionMatrix,Me.matrixWorldInverse),V._frustum.setFromProjectionMatrix(yo,Me.coordinateSystem,Me.reversedDepth)}else V.updateMatrices(G);n=V.getFrustum(),y(D,v,V.camera,G,this.type)}V.isPointLightShadow!==!0&&this.type===yi&&M(V,v),V.needsUpdate=!1}h=this.type,f.needsUpdate=!1,i.setRenderTarget(A,I,R)};function M(b,D){const v=e.update(E);u.defines.VSM_SAMPLES!==b.blurSamples&&(u.defines.VSM_SAMPLES=b.blurSamples,m.defines.VSM_SAMPLES=b.blurSamples,u.needsUpdate=!0,m.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new tn(s.x,s.y,{format:Vn,type:mn})),u.uniforms.shadow_pass.value=b.map.depthTexture,u.uniforms.resolution.value=b.mapSize,u.uniforms.radius.value=b.radius,i.setRenderTarget(b.mapPass),i.clear(),i.renderBufferDirect(D,null,v,u,E,null),m.uniforms.shadow_pass.value=b.mapPass.texture,m.uniforms.resolution.value=b.mapSize,m.uniforms.radius.value=b.radius,i.setRenderTarget(b.map),i.clear(),i.renderBufferDirect(D,null,v,m,E,null)}function T(b,D,v,A){let I=null;const R=v.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(R!==void 0)I=R;else if(I=v.isPointLight===!0?l:o,i.localClippingEnabled&&D.clipShadows===!0&&Array.isArray(D.clippingPlanes)&&D.clippingPlanes.length!==0||D.displacementMap&&D.displacementScale!==0||D.alphaMap&&D.alphaTest>0||D.map&&D.alphaTest>0||D.alphaToCoverage===!0){const O=I.uuid,X=D.uuid;let W=c[O];W===void 0&&(W={},c[O]=W);let U=W[X];U===void 0&&(U=I.clone(),W[X]=U,D.addEventListener("dispose",N)),I=U}if(I.visible=D.visible,I.wireframe=D.wireframe,A===yi?I.side=D.shadowSide!==null?D.shadowSide:D.side:I.side=D.shadowSide!==null?D.shadowSide:p[D.side],I.alphaMap=D.alphaMap,I.alphaTest=D.alphaToCoverage===!0?.5:D.alphaTest,I.map=D.map,I.clipShadows=D.clipShadows,I.clippingPlanes=D.clippingPlanes,I.clipIntersection=D.clipIntersection,I.displacementMap=D.displacementMap,I.displacementScale=D.displacementScale,I.displacementBias=D.displacementBias,I.wireframeLinewidth=D.wireframeLinewidth,I.linewidth=D.linewidth,v.isPointLight===!0&&I.isMeshDistanceMaterial===!0){const O=i.properties.get(I);O.light=v}return I}function y(b,D,v,A,I){if(b.visible===!1)return;if(b.layers.test(D.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&I===yi)&&(!b.frustumCulled||n.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(v.matrixWorldInverse,b.matrixWorld);const X=e.update(b),W=b.material;if(Array.isArray(W)){const U=X.groups;for(let G=0,V=U.length;G<V;G++){const $=U[G],ee=W[$.materialIndex];if(ee&&ee.visible){const le=T(b,ee,A,I);b.onBeforeShadow(i,b,D,v,X,le,$),i.renderBufferDirect(v,null,X,le,b,$),b.onAfterShadow(i,b,D,v,X,le,$)}}}else if(W.visible){const U=T(b,W,A,I);b.onBeforeShadow(i,b,D,v,X,U,null),i.renderBufferDirect(v,null,X,U,b,null),b.onAfterShadow(i,b,D,v,X,U,null)}}const O=b.children;for(let X=0,W=O.length;X<W;X++)y(O[X],D,v,A,I)}function N(b){b.target.removeEventListener("dispose",N);for(const v in c){const A=c[v],I=b.target.uuid;I in A&&(A[I].dispose(),delete A[I])}}}function cg(i,e){function t(){let C=!1;const se=new pt;let q=null;const me=new pt(0,0,0,0);return{setMask:function(ae){q!==ae&&!C&&(i.colorMask(ae,ae,ae,ae),q=ae)},setLocked:function(ae){C=ae},setClear:function(ae,J,Ee,De,ht){ht===!0&&(ae*=De,J*=De,Ee*=De),se.set(ae,J,Ee,De),me.equals(se)===!1&&(i.clearColor(ae,J,Ee,De),me.copy(se))},reset:function(){C=!1,q=null,me.set(-1,0,0,0)}}}function n(){let C=!1,se=!1,q=null,me=null,ae=null;return{setReversed:function(J){if(se!==J){const Ee=e.get("EXT_clip_control");J?Ee.clipControlEXT(Ee.LOWER_LEFT_EXT,Ee.ZERO_TO_ONE_EXT):Ee.clipControlEXT(Ee.LOWER_LEFT_EXT,Ee.NEGATIVE_ONE_TO_ONE_EXT),se=J;const De=ae;ae=null,this.setClear(De)}},getReversed:function(){return se},setTest:function(J){J?te(i.DEPTH_TEST):Te(i.DEPTH_TEST)},setMask:function(J){q!==J&&!C&&(i.depthMask(J),q=J)},setFunc:function(J){if(se&&(J=Vu[J]),me!==J){switch(J){case lr:i.depthFunc(i.NEVER);break;case cr:i.depthFunc(i.ALWAYS);break;case ur:i.depthFunc(i.LESS);break;case ui:i.depthFunc(i.LEQUAL);break;case hr:i.depthFunc(i.EQUAL);break;case dr:i.depthFunc(i.GEQUAL);break;case fr:i.depthFunc(i.GREATER);break;case pr:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}me=J}},setLocked:function(J){C=J},setClear:function(J){ae!==J&&(ae=J,se&&(J=1-J),i.clearDepth(J))},reset:function(){C=!1,q=null,me=null,ae=null,se=!1}}}function s(){let C=!1,se=null,q=null,me=null,ae=null,J=null,Ee=null,De=null,ht=null;return{setTest:function(et){C||(et?te(i.STENCIL_TEST):Te(i.STENCIL_TEST))},setMask:function(et){se!==et&&!C&&(i.stencilMask(et),se=et)},setFunc:function(et,sn,qt){(q!==et||me!==sn||ae!==qt)&&(i.stencilFunc(et,sn,qt),q=et,me=sn,ae=qt)},setOp:function(et,sn,qt){(J!==et||Ee!==sn||De!==qt)&&(i.stencilOp(et,sn,qt),J=et,Ee=sn,De=qt)},setLocked:function(et){C=et},setClear:function(et){ht!==et&&(i.clearStencil(et),ht=et)},reset:function(){C=!1,se=null,q=null,me=null,ae=null,J=null,Ee=null,De=null,ht=null}}}const r=new t,a=new n,o=new s,l=new WeakMap,c=new WeakMap;let d={},p={},u={},m=new WeakMap,_=[],E=null,f=!1,h=null,M=null,T=null,y=null,N=null,b=null,D=null,v=new $e(0,0,0),A=0,I=!1,R=null,O=null,X=null,W=null,U=null;const G=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let V=!1,$=0;const ee=i.getParameter(i.VERSION);ee.indexOf("WebGL")!==-1?($=parseFloat(/^WebGL (\d)/.exec(ee)[1]),V=$>=1):ee.indexOf("OpenGL ES")!==-1&&($=parseFloat(/^OpenGL ES (\d)/.exec(ee)[1]),V=$>=2);let le=null,ve={};const Me=i.getParameter(i.SCISSOR_BOX),He=i.getParameter(i.VIEWPORT),Ge=new pt().fromArray(Me),Pe=new pt().fromArray(He);function K(C,se,q,me){const ae=new Uint8Array(4),J=i.createTexture();i.bindTexture(C,J),i.texParameteri(C,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(C,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Ee=0;Ee<q;Ee++)C===i.TEXTURE_3D||C===i.TEXTURE_2D_ARRAY?i.texImage3D(se,0,i.RGBA,1,1,me,0,i.RGBA,i.UNSIGNED_BYTE,ae):i.texImage2D(se+Ee,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ae);return J}const ce={};ce[i.TEXTURE_2D]=K(i.TEXTURE_2D,i.TEXTURE_2D,1),ce[i.TEXTURE_CUBE_MAP]=K(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),ce[i.TEXTURE_2D_ARRAY]=K(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),ce[i.TEXTURE_3D]=K(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),te(i.DEPTH_TEST),a.setFunc(ui),ut(!1),at(Ta),te(i.CULL_FACE),Qe(dn);function te(C){d[C]!==!0&&(i.enable(C),d[C]=!0)}function Te(C){d[C]!==!1&&(i.disable(C),d[C]=!1)}function Re(C,se){return u[C]!==se?(i.bindFramebuffer(C,se),u[C]=se,C===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=se),C===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=se),!0):!1}function Ae(C,se){let q=_,me=!1;if(C){q=m.get(se),q===void 0&&(q=[],m.set(se,q));const ae=C.textures;if(q.length!==ae.length||q[0]!==i.COLOR_ATTACHMENT0){for(let J=0,Ee=ae.length;J<Ee;J++)q[J]=i.COLOR_ATTACHMENT0+J;q.length=ae.length,me=!0}}else q[0]!==i.BACK&&(q[0]=i.BACK,me=!0);me&&i.drawBuffers(q)}function Je(C){return E!==C?(i.useProgram(C),E=C,!0):!1}const ze={[On]:i.FUNC_ADD,[hu]:i.FUNC_SUBTRACT,[du]:i.FUNC_REVERSE_SUBTRACT};ze[fu]=i.MIN,ze[pu]=i.MAX;const Ye={[mu]:i.ZERO,[gu]:i.ONE,[_u]:i.SRC_COLOR,[ar]:i.SRC_ALPHA,[bu]:i.SRC_ALPHA_SATURATE,[Mu]:i.DST_COLOR,[vu]:i.DST_ALPHA,[xu]:i.ONE_MINUS_SRC_COLOR,[or]:i.ONE_MINUS_SRC_ALPHA,[Eu]:i.ONE_MINUS_DST_COLOR,[Su]:i.ONE_MINUS_DST_ALPHA,[yu]:i.CONSTANT_COLOR,[Tu]:i.ONE_MINUS_CONSTANT_COLOR,[Au]:i.CONSTANT_ALPHA,[wu]:i.ONE_MINUS_CONSTANT_ALPHA};function Qe(C,se,q,me,ae,J,Ee,De,ht,et){if(C===dn){f===!0&&(Te(i.BLEND),f=!1);return}if(f===!1&&(te(i.BLEND),f=!0),C!==uu){if(C!==h||et!==I){if((M!==On||N!==On)&&(i.blendEquation(i.FUNC_ADD),M=On,N=On),et)switch(C){case li:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case rr:i.blendFunc(i.ONE,i.ONE);break;case Aa:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case wa:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Xe("WebGLState: Invalid blending: ",C);break}else switch(C){case li:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case rr:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Aa:Xe("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case wa:Xe("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Xe("WebGLState: Invalid blending: ",C);break}T=null,y=null,b=null,D=null,v.set(0,0,0),A=0,h=C,I=et}return}ae=ae||se,J=J||q,Ee=Ee||me,(se!==M||ae!==N)&&(i.blendEquationSeparate(ze[se],ze[ae]),M=se,N=ae),(q!==T||me!==y||J!==b||Ee!==D)&&(i.blendFuncSeparate(Ye[q],Ye[me],Ye[J],Ye[Ee]),T=q,y=me,b=J,D=Ee),(De.equals(v)===!1||ht!==A)&&(i.blendColor(De.r,De.g,De.b,ht),v.copy(De),A=ht),h=C,I=!1}function Oe(C,se){C.side===un?Te(i.CULL_FACE):te(i.CULL_FACE);let q=C.side===Pt;se&&(q=!q),ut(q),C.blending===li&&C.transparent===!1?Qe(dn):Qe(C.blending,C.blendEquation,C.blendSrc,C.blendDst,C.blendEquationAlpha,C.blendSrcAlpha,C.blendDstAlpha,C.blendColor,C.blendAlpha,C.premultipliedAlpha),a.setFunc(C.depthFunc),a.setTest(C.depthTest),a.setMask(C.depthWrite),r.setMask(C.colorWrite);const me=C.stencilWrite;o.setTest(me),me&&(o.setMask(C.stencilWriteMask),o.setFunc(C.stencilFunc,C.stencilRef,C.stencilFuncMask),o.setOp(C.stencilFail,C.stencilZFail,C.stencilZPass)),P(C.polygonOffset,C.polygonOffsetFactor,C.polygonOffsetUnits),C.alphaToCoverage===!0?te(i.SAMPLE_ALPHA_TO_COVERAGE):Te(i.SAMPLE_ALPHA_TO_COVERAGE)}function ut(C){R!==C&&(C?i.frontFace(i.CW):i.frontFace(i.CCW),R=C)}function at(C){C!==ou?(te(i.CULL_FACE),C!==O&&(C===Ta?i.cullFace(i.BACK):C===lu?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Te(i.CULL_FACE),O=C}function At(C){C!==X&&(V&&i.lineWidth(C),X=C)}function P(C,se,q){C?(te(i.POLYGON_OFFSET_FILL),(W!==se||U!==q)&&(W=se,U=q,a.getReversed()&&(se=-se),i.polygonOffset(se,q))):Te(i.POLYGON_OFFSET_FILL)}function ot(C){C?te(i.SCISSOR_TEST):Te(i.SCISSOR_TEST)}function Ie(C){C===void 0&&(C=i.TEXTURE0+G-1),le!==C&&(i.activeTexture(C),le=C)}function Ke(C,se,q){q===void 0&&(le===null?q=i.TEXTURE0+G-1:q=le);let me=ve[q];me===void 0&&(me={type:void 0,texture:void 0},ve[q]=me),(me.type!==C||me.texture!==se)&&(le!==q&&(i.activeTexture(q),le=q),i.bindTexture(C,se||ce[C]),me.type=C,me.texture=se)}function ue(){const C=ve[le];C!==void 0&&C.type!==void 0&&(i.bindTexture(C.type,null),C.type=void 0,C.texture=void 0)}function lt(){try{i.compressedTexImage2D(...arguments)}catch(C){Xe("WebGLState:",C)}}function S(){try{i.compressedTexImage3D(...arguments)}catch(C){Xe("WebGLState:",C)}}function g(){try{i.texSubImage2D(...arguments)}catch(C){Xe("WebGLState:",C)}}function F(){try{i.texSubImage3D(...arguments)}catch(C){Xe("WebGLState:",C)}}function Y(){try{i.compressedTexSubImage2D(...arguments)}catch(C){Xe("WebGLState:",C)}}function Q(){try{i.compressedTexSubImage3D(...arguments)}catch(C){Xe("WebGLState:",C)}}function ne(){try{i.texStorage2D(...arguments)}catch(C){Xe("WebGLState:",C)}}function oe(){try{i.texStorage3D(...arguments)}catch(C){Xe("WebGLState:",C)}}function j(){try{i.texImage2D(...arguments)}catch(C){Xe("WebGLState:",C)}}function Z(){try{i.texImage3D(...arguments)}catch(C){Xe("WebGLState:",C)}}function pe(C){return p[C]!==void 0?p[C]:i.getParameter(C)}function _e(C,se){p[C]!==se&&(i.pixelStorei(C,se),p[C]=se)}function re(C){Ge.equals(C)===!1&&(i.scissor(C.x,C.y,C.z,C.w),Ge.copy(C))}function ie(C){Pe.equals(C)===!1&&(i.viewport(C.x,C.y,C.z,C.w),Pe.copy(C))}function Ce(C,se){let q=c.get(se);q===void 0&&(q=new WeakMap,c.set(se,q));let me=q.get(C);me===void 0&&(me=i.getUniformBlockIndex(se,C.name),q.set(C,me))}function Ue(C,se){const me=c.get(se).get(C);l.get(se)!==me&&(i.uniformBlockBinding(se,me,C.__bindingPointIndex),l.set(se,me))}function je(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),d={},p={},le=null,ve={},u={},m=new WeakMap,_=[],E=null,f=!1,h=null,M=null,T=null,y=null,N=null,b=null,D=null,v=new $e(0,0,0),A=0,I=!1,R=null,O=null,X=null,W=null,U=null,Ge.set(0,0,i.canvas.width,i.canvas.height),Pe.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:te,disable:Te,bindFramebuffer:Re,drawBuffers:Ae,useProgram:Je,setBlending:Qe,setMaterial:Oe,setFlipSided:ut,setCullFace:at,setLineWidth:At,setPolygonOffset:P,setScissorTest:ot,activeTexture:Ie,bindTexture:Ke,unbindTexture:ue,compressedTexImage2D:lt,compressedTexImage3D:S,texImage2D:j,texImage3D:Z,pixelStorei:_e,getParameter:pe,updateUBOMapping:Ce,uniformBlockBinding:Ue,texStorage2D:ne,texStorage3D:oe,texSubImage2D:g,texSubImage3D:F,compressedTexSubImage2D:Y,compressedTexSubImage3D:Q,scissor:re,viewport:ie,reset:je}}function ug(i,e,t,n,s,r,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new qe,d=new WeakMap,p=new Set;let u;const m=new WeakMap;let _=!1;try{_=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function E(S,g){return _?new OffscreenCanvas(S,g):_s("canvas")}function f(S,g,F){let Y=1;const Q=lt(S);if((Q.width>F||Q.height>F)&&(Y=F/Math.max(Q.width,Q.height)),Y<1)if(typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&S instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&S instanceof ImageBitmap||typeof VideoFrame<"u"&&S instanceof VideoFrame){const ne=Math.floor(Y*Q.width),oe=Math.floor(Y*Q.height);u===void 0&&(u=E(ne,oe));const j=g?E(ne,oe):u;return j.width=ne,j.height=oe,j.getContext("2d").drawImage(S,0,0,ne,oe),we("WebGLRenderer: Texture has been resized from ("+Q.width+"x"+Q.height+") to ("+ne+"x"+oe+")."),j}else return"data"in S&&we("WebGLRenderer: Image in DataTexture is too big ("+Q.width+"x"+Q.height+")."),S;return S}function h(S){return S.generateMipmaps}function M(S){i.generateMipmap(S)}function T(S){return S.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:S.isWebGL3DRenderTarget?i.TEXTURE_3D:S.isWebGLArrayRenderTarget||S.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function y(S,g,F,Y,Q,ne=!1){if(S!==null){if(i[S]!==void 0)return i[S];we("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+S+"'")}let oe;Y&&(oe=e.get("EXT_texture_norm16"),oe||we("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let j=g;if(g===i.RED&&(F===i.FLOAT&&(j=i.R32F),F===i.HALF_FLOAT&&(j=i.R16F),F===i.UNSIGNED_BYTE&&(j=i.R8),F===i.UNSIGNED_SHORT&&oe&&(j=oe.R16_EXT),F===i.SHORT&&oe&&(j=oe.R16_SNORM_EXT)),g===i.RED_INTEGER&&(F===i.UNSIGNED_BYTE&&(j=i.R8UI),F===i.UNSIGNED_SHORT&&(j=i.R16UI),F===i.UNSIGNED_INT&&(j=i.R32UI),F===i.BYTE&&(j=i.R8I),F===i.SHORT&&(j=i.R16I),F===i.INT&&(j=i.R32I)),g===i.RG&&(F===i.FLOAT&&(j=i.RG32F),F===i.HALF_FLOAT&&(j=i.RG16F),F===i.UNSIGNED_BYTE&&(j=i.RG8),F===i.UNSIGNED_SHORT&&oe&&(j=oe.RG16_EXT),F===i.SHORT&&oe&&(j=oe.RG16_SNORM_EXT)),g===i.RG_INTEGER&&(F===i.UNSIGNED_BYTE&&(j=i.RG8UI),F===i.UNSIGNED_SHORT&&(j=i.RG16UI),F===i.UNSIGNED_INT&&(j=i.RG32UI),F===i.BYTE&&(j=i.RG8I),F===i.SHORT&&(j=i.RG16I),F===i.INT&&(j=i.RG32I)),g===i.RGB_INTEGER&&(F===i.UNSIGNED_BYTE&&(j=i.RGB8UI),F===i.UNSIGNED_SHORT&&(j=i.RGB16UI),F===i.UNSIGNED_INT&&(j=i.RGB32UI),F===i.BYTE&&(j=i.RGB8I),F===i.SHORT&&(j=i.RGB16I),F===i.INT&&(j=i.RGB32I)),g===i.RGBA_INTEGER&&(F===i.UNSIGNED_BYTE&&(j=i.RGBA8UI),F===i.UNSIGNED_SHORT&&(j=i.RGBA16UI),F===i.UNSIGNED_INT&&(j=i.RGBA32UI),F===i.BYTE&&(j=i.RGBA8I),F===i.SHORT&&(j=i.RGBA16I),F===i.INT&&(j=i.RGBA32I)),g===i.RGB&&(F===i.UNSIGNED_SHORT&&oe&&(j=oe.RGB16_EXT),F===i.SHORT&&oe&&(j=oe.RGB16_SNORM_EXT),F===i.UNSIGNED_INT_5_9_9_9_REV&&(j=i.RGB9_E5),F===i.UNSIGNED_INT_10F_11F_11F_REV&&(j=i.R11F_G11F_B10F)),g===i.RGBA){const Z=ne?ms:Ve.getTransfer(Q);F===i.FLOAT&&(j=i.RGBA32F),F===i.HALF_FLOAT&&(j=i.RGBA16F),F===i.UNSIGNED_BYTE&&(j=Z===Ze?i.SRGB8_ALPHA8:i.RGBA8),F===i.UNSIGNED_SHORT&&oe&&(j=oe.RGBA16_EXT),F===i.SHORT&&oe&&(j=oe.RGBA16_SNORM_EXT),F===i.UNSIGNED_SHORT_4_4_4_4&&(j=i.RGBA4),F===i.UNSIGNED_SHORT_5_5_5_1&&(j=i.RGB5_A1)}return(j===i.R16F||j===i.R32F||j===i.RG16F||j===i.RG32F||j===i.RGBA16F||j===i.RGBA32F)&&e.get("EXT_color_buffer_float"),j}function N(S,g){let F;return S?g===null||g===nn||g===wi?F=i.DEPTH24_STENCIL8:g===Jt?F=i.DEPTH32F_STENCIL8:g===Ai&&(F=i.DEPTH24_STENCIL8,we("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===nn||g===wi?F=i.DEPTH_COMPONENT24:g===Jt?F=i.DEPTH_COMPONENT32F:g===Ai&&(F=i.DEPTH_COMPONENT16),F}function b(S,g){return h(S)===!0||S.isFramebufferTexture&&S.minFilter!==St&&S.minFilter!==Tt?Math.log2(Math.max(g.width,g.height))+1:S.mipmaps!==void 0&&S.mipmaps.length>0?S.mipmaps.length:S.isCompressedTexture&&Array.isArray(S.image)?g.mipmaps.length:1}function D(S){const g=S.target;g.removeEventListener("dispose",D),A(g),g.isVideoTexture&&d.delete(g),g.isHTMLTexture&&p.delete(g)}function v(S){const g=S.target;g.removeEventListener("dispose",v),R(g)}function A(S){const g=n.get(S);if(g.__webglInit===void 0)return;const F=S.source,Y=m.get(F);if(Y){const Q=Y[g.__cacheKey];Q.usedTimes--,Q.usedTimes===0&&I(S),Object.keys(Y).length===0&&m.delete(F)}n.remove(S)}function I(S){const g=n.get(S);i.deleteTexture(g.__webglTexture);const F=S.source,Y=m.get(F);delete Y[g.__cacheKey],a.memory.textures--}function R(S){const g=n.get(S);if(S.depthTexture&&(S.depthTexture.dispose(),n.remove(S.depthTexture)),S.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(g.__webglFramebuffer[Y]))for(let Q=0;Q<g.__webglFramebuffer[Y].length;Q++)i.deleteFramebuffer(g.__webglFramebuffer[Y][Q]);else i.deleteFramebuffer(g.__webglFramebuffer[Y]);g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer[Y])}else{if(Array.isArray(g.__webglFramebuffer))for(let Y=0;Y<g.__webglFramebuffer.length;Y++)i.deleteFramebuffer(g.__webglFramebuffer[Y]);else i.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&i.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let Y=0;Y<g.__webglColorRenderbuffer.length;Y++)g.__webglColorRenderbuffer[Y]&&i.deleteRenderbuffer(g.__webglColorRenderbuffer[Y]);g.__webglDepthRenderbuffer&&i.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const F=S.textures;for(let Y=0,Q=F.length;Y<Q;Y++){const ne=n.get(F[Y]);ne.__webglTexture&&(i.deleteTexture(ne.__webglTexture),a.memory.textures--),n.remove(F[Y])}n.remove(S)}let O=0;function X(){O=0}function W(){return O}function U(S){O=S}function G(){const S=O;return S>=s.maxTextures&&we("WebGLTextures: Trying to use "+S+" texture units while this GPU supports only "+s.maxTextures),O+=1,S}function V(S){const g=[];return g.push(S.wrapS),g.push(S.wrapT),g.push(S.wrapR||0),g.push(S.magFilter),g.push(S.minFilter),g.push(S.anisotropy),g.push(S.internalFormat),g.push(S.format),g.push(S.type),g.push(S.generateMipmaps),g.push(S.premultiplyAlpha),g.push(S.flipY),g.push(S.unpackAlignment),g.push(S.colorSpace),g.join()}function $(S,g){const F=n.get(S);if(S.isVideoTexture&&Ke(S),S.isRenderTargetTexture===!1&&S.isExternalTexture!==!0&&S.version>0&&F.__version!==S.version){const Y=S.image;if(Y===null)we("WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)we("WebGLRenderer: Texture marked for update but image is incomplete");else{Te(F,S,g);return}}else S.isExternalTexture&&(F.__webglTexture=S.sourceTexture?S.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,F.__webglTexture,i.TEXTURE0+g)}function ee(S,g){const F=n.get(S);if(S.isRenderTargetTexture===!1&&S.version>0&&F.__version!==S.version){Te(F,S,g);return}else S.isExternalTexture&&(F.__webglTexture=S.sourceTexture?S.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,F.__webglTexture,i.TEXTURE0+g)}function le(S,g){const F=n.get(S);if(S.isRenderTargetTexture===!1&&S.version>0&&F.__version!==S.version){Te(F,S,g);return}t.bindTexture(i.TEXTURE_3D,F.__webglTexture,i.TEXTURE0+g)}function ve(S,g){const F=n.get(S);if(S.isCubeDepthTexture!==!0&&S.version>0&&F.__version!==S.version){Re(F,S,g);return}t.bindTexture(i.TEXTURE_CUBE_MAP,F.__webglTexture,i.TEXTURE0+g)}const Me={[mr]:i.REPEAT,[hn]:i.CLAMP_TO_EDGE,[gr]:i.MIRRORED_REPEAT},He={[St]:i.NEAREST,[Pu]:i.NEAREST_MIPMAP_NEAREST,[Ui]:i.NEAREST_MIPMAP_LINEAR,[Tt]:i.LINEAR,[Rs]:i.LINEAR_MIPMAP_NEAREST,[zn]:i.LINEAR_MIPMAP_LINEAR},Ge={[Lu]:i.NEVER,[Bu]:i.ALWAYS,[Uu]:i.LESS,[ra]:i.LEQUAL,[Iu]:i.EQUAL,[aa]:i.GEQUAL,[Fu]:i.GREATER,[Ou]:i.NOTEQUAL};function Pe(S,g){if(g.type===Jt&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===Tt||g.magFilter===Rs||g.magFilter===Ui||g.magFilter===zn||g.minFilter===Tt||g.minFilter===Rs||g.minFilter===Ui||g.minFilter===zn)&&we("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(S,i.TEXTURE_WRAP_S,Me[g.wrapS]),i.texParameteri(S,i.TEXTURE_WRAP_T,Me[g.wrapT]),(S===i.TEXTURE_3D||S===i.TEXTURE_2D_ARRAY)&&i.texParameteri(S,i.TEXTURE_WRAP_R,Me[g.wrapR]),i.texParameteri(S,i.TEXTURE_MAG_FILTER,He[g.magFilter]),i.texParameteri(S,i.TEXTURE_MIN_FILTER,He[g.minFilter]),g.compareFunction&&(i.texParameteri(S,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(S,i.TEXTURE_COMPARE_FUNC,Ge[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===St||g.minFilter!==Ui&&g.minFilter!==zn||g.type===Jt&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||n.get(g).__currentAnisotropy){const F=e.get("EXT_texture_filter_anisotropic");i.texParameterf(S,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,s.getMaxAnisotropy())),n.get(g).__currentAnisotropy=g.anisotropy}}}function K(S,g){let F=!1;S.__webglInit===void 0&&(S.__webglInit=!0,g.addEventListener("dispose",D));const Y=g.source;let Q=m.get(Y);Q===void 0&&(Q={},m.set(Y,Q));const ne=V(g);if(ne!==S.__cacheKey){Q[ne]===void 0&&(Q[ne]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,F=!0),Q[ne].usedTimes++;const oe=Q[S.__cacheKey];oe!==void 0&&(Q[S.__cacheKey].usedTimes--,oe.usedTimes===0&&I(g)),S.__cacheKey=ne,S.__webglTexture=Q[ne].texture}return F}function ce(S,g,F){return Math.floor(Math.floor(S/F)/g)}function te(S,g,F,Y){const ne=S.updateRanges;if(ne.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,g.width,g.height,F,Y,g.data);else{ne.sort((_e,re)=>_e.start-re.start);let oe=0;for(let _e=1;_e<ne.length;_e++){const re=ne[oe],ie=ne[_e],Ce=re.start+re.count,Ue=ce(ie.start,g.width,4),je=ce(re.start,g.width,4);ie.start<=Ce+1&&Ue===je&&ce(ie.start+ie.count-1,g.width,4)===Ue?re.count=Math.max(re.count,ie.start+ie.count-re.start):(++oe,ne[oe]=ie)}ne.length=oe+1;const j=t.getParameter(i.UNPACK_ROW_LENGTH),Z=t.getParameter(i.UNPACK_SKIP_PIXELS),pe=t.getParameter(i.UNPACK_SKIP_ROWS);t.pixelStorei(i.UNPACK_ROW_LENGTH,g.width);for(let _e=0,re=ne.length;_e<re;_e++){const ie=ne[_e],Ce=Math.floor(ie.start/4),Ue=Math.ceil(ie.count/4),je=Ce%g.width,C=Math.floor(Ce/g.width),se=Ue,q=1;t.pixelStorei(i.UNPACK_SKIP_PIXELS,je),t.pixelStorei(i.UNPACK_SKIP_ROWS,C),t.texSubImage2D(i.TEXTURE_2D,0,je,C,se,q,F,Y,g.data)}S.clearUpdateRanges(),t.pixelStorei(i.UNPACK_ROW_LENGTH,j),t.pixelStorei(i.UNPACK_SKIP_PIXELS,Z),t.pixelStorei(i.UNPACK_SKIP_ROWS,pe)}}function Te(S,g,F){let Y=i.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(Y=i.TEXTURE_2D_ARRAY),g.isData3DTexture&&(Y=i.TEXTURE_3D);const Q=K(S,g),ne=g.source;t.bindTexture(Y,S.__webglTexture,i.TEXTURE0+F);const oe=n.get(ne);if(ne.version!==oe.__version||Q===!0){if(t.activeTexture(i.TEXTURE0+F),(typeof ImageBitmap<"u"&&g.image instanceof ImageBitmap)===!1){const q=Ve.getPrimaries(Ve.workingColorSpace),me=g.colorSpace===Rn?null:Ve.getPrimaries(g.colorSpace),ae=g.colorSpace===Rn||q===me?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ae)}t.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment);let Z=f(g.image,!1,s.maxTextureSize);Z=ue(g,Z);const pe=r.convert(g.format,g.colorSpace),_e=r.convert(g.type);let re=y(g.internalFormat,pe,_e,g.normalized,g.colorSpace,g.isVideoTexture);Pe(Y,g);let ie;const Ce=g.mipmaps,Ue=g.isVideoTexture!==!0,je=oe.__version===void 0||Q===!0,C=ne.dataReady,se=b(g,Z);if(g.isDepthTexture)re=N(g.format===Gn,g.type),je&&(Ue?t.texStorage2D(i.TEXTURE_2D,1,re,Z.width,Z.height):t.texImage2D(i.TEXTURE_2D,0,re,Z.width,Z.height,0,pe,_e,null));else if(g.isDataTexture)if(Ce.length>0){Ue&&je&&t.texStorage2D(i.TEXTURE_2D,se,re,Ce[0].width,Ce[0].height);for(let q=0,me=Ce.length;q<me;q++)ie=Ce[q],Ue?C&&t.texSubImage2D(i.TEXTURE_2D,q,0,0,ie.width,ie.height,pe,_e,ie.data):t.texImage2D(i.TEXTURE_2D,q,re,ie.width,ie.height,0,pe,_e,ie.data);g.generateMipmaps=!1}else Ue?(je&&t.texStorage2D(i.TEXTURE_2D,se,re,Z.width,Z.height),C&&te(g,Z,pe,_e)):t.texImage2D(i.TEXTURE_2D,0,re,Z.width,Z.height,0,pe,_e,Z.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){Ue&&je&&t.texStorage3D(i.TEXTURE_2D_ARRAY,se,re,Ce[0].width,Ce[0].height,Z.depth);for(let q=0,me=Ce.length;q<me;q++)if(ie=Ce[q],g.format!==Wt)if(pe!==null)if(Ue){if(C)if(g.layerUpdates.size>0){const ae=eo(ie.width,ie.height,g.format,g.type);for(const J of g.layerUpdates){const Ee=ie.data.subarray(J*ae/ie.data.BYTES_PER_ELEMENT,(J+1)*ae/ie.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,J,ie.width,ie.height,1,pe,Ee)}g.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,0,ie.width,ie.height,Z.depth,pe,ie.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,q,re,ie.width,ie.height,Z.depth,0,ie.data,0,0);else we("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ue?C&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,0,ie.width,ie.height,Z.depth,pe,_e,ie.data):t.texImage3D(i.TEXTURE_2D_ARRAY,q,re,ie.width,ie.height,Z.depth,0,pe,_e,ie.data)}else{Ue&&je&&t.texStorage2D(i.TEXTURE_2D,se,re,Ce[0].width,Ce[0].height);for(let q=0,me=Ce.length;q<me;q++)ie=Ce[q],g.format!==Wt?pe!==null?Ue?C&&t.compressedTexSubImage2D(i.TEXTURE_2D,q,0,0,ie.width,ie.height,pe,ie.data):t.compressedTexImage2D(i.TEXTURE_2D,q,re,ie.width,ie.height,0,ie.data):we("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ue?C&&t.texSubImage2D(i.TEXTURE_2D,q,0,0,ie.width,ie.height,pe,_e,ie.data):t.texImage2D(i.TEXTURE_2D,q,re,ie.width,ie.height,0,pe,_e,ie.data)}else if(g.isDataArrayTexture)if(Ue){if(je&&t.texStorage3D(i.TEXTURE_2D_ARRAY,se,re,Z.width,Z.height,Z.depth),C)if(g.layerUpdates.size>0){const q=eo(Z.width,Z.height,g.format,g.type);for(const me of g.layerUpdates){const ae=Z.data.subarray(me*q/Z.data.BYTES_PER_ELEMENT,(me+1)*q/Z.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,me,Z.width,Z.height,1,pe,_e,ae)}g.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,Z.width,Z.height,Z.depth,pe,_e,Z.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,re,Z.width,Z.height,Z.depth,0,pe,_e,Z.data);else if(g.isData3DTexture)Ue?(je&&t.texStorage3D(i.TEXTURE_3D,se,re,Z.width,Z.height,Z.depth),C&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,Z.width,Z.height,Z.depth,pe,_e,Z.data)):t.texImage3D(i.TEXTURE_3D,0,re,Z.width,Z.height,Z.depth,0,pe,_e,Z.data);else if(g.isFramebufferTexture){if(je)if(Ue)t.texStorage2D(i.TEXTURE_2D,se,re,Z.width,Z.height);else{let q=Z.width,me=Z.height;for(let ae=0;ae<se;ae++)t.texImage2D(i.TEXTURE_2D,ae,re,q,me,0,pe,_e,null),q>>=1,me>>=1}}else if(g.isHTMLTexture){if("texElementImage2D"in i){const q=i.canvas;if(q.hasAttribute("layoutsubtree")||q.setAttribute("layoutsubtree","true"),Z.parentNode!==q){q.appendChild(Z),p.add(g),q.onpaint=De=>{const ht=De.changedElements;for(const et of p)ht.includes(et.image)&&(et.needsUpdate=!0)},q.requestPaint();return}const me=0,ae=i.RGBA,J=i.RGBA,Ee=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,me,ae,J,Ee,Z),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Ce.length>0){if(Ue&&je){const q=lt(Ce[0]);t.texStorage2D(i.TEXTURE_2D,se,re,q.width,q.height)}for(let q=0,me=Ce.length;q<me;q++)ie=Ce[q],Ue?C&&t.texSubImage2D(i.TEXTURE_2D,q,0,0,pe,_e,ie):t.texImage2D(i.TEXTURE_2D,q,re,pe,_e,ie);g.generateMipmaps=!1}else if(Ue){if(je){const q=lt(Z);t.texStorage2D(i.TEXTURE_2D,se,re,q.width,q.height)}C&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,pe,_e,Z)}else t.texImage2D(i.TEXTURE_2D,0,re,pe,_e,Z);h(g)&&M(Y),oe.__version=ne.version,g.onUpdate&&g.onUpdate(g)}S.__version=g.version}function Re(S,g,F){if(g.image.length!==6)return;const Y=K(S,g),Q=g.source;t.bindTexture(i.TEXTURE_CUBE_MAP,S.__webglTexture,i.TEXTURE0+F);const ne=n.get(Q);if(Q.version!==ne.__version||Y===!0){t.activeTexture(i.TEXTURE0+F);const oe=Ve.getPrimaries(Ve.workingColorSpace),j=g.colorSpace===Rn?null:Ve.getPrimaries(g.colorSpace),Z=g.colorSpace===Rn||oe===j?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),t.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Z);const pe=g.isCompressedTexture||g.image[0].isCompressedTexture,_e=g.image[0]&&g.image[0].isDataTexture,re=[];for(let J=0;J<6;J++)!pe&&!_e?re[J]=f(g.image[J],!0,s.maxCubemapSize):re[J]=_e?g.image[J].image:g.image[J],re[J]=ue(g,re[J]);const ie=re[0],Ce=r.convert(g.format,g.colorSpace),Ue=r.convert(g.type),je=y(g.internalFormat,Ce,Ue,g.normalized,g.colorSpace),C=g.isVideoTexture!==!0,se=ne.__version===void 0||Y===!0,q=Q.dataReady;let me=b(g,ie);Pe(i.TEXTURE_CUBE_MAP,g);let ae;if(pe){C&&se&&t.texStorage2D(i.TEXTURE_CUBE_MAP,me,je,ie.width,ie.height);for(let J=0;J<6;J++){ae=re[J].mipmaps;for(let Ee=0;Ee<ae.length;Ee++){const De=ae[Ee];g.format!==Wt?Ce!==null?C?q&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,Ee,0,0,De.width,De.height,Ce,De.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,Ee,je,De.width,De.height,0,De.data):we("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):C?q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,Ee,0,0,De.width,De.height,Ce,Ue,De.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,Ee,je,De.width,De.height,0,Ce,Ue,De.data)}}}else{if(ae=g.mipmaps,C&&se){ae.length>0&&me++;const J=lt(re[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,me,je,J.width,J.height)}for(let J=0;J<6;J++)if(_e){C?q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,re[J].width,re[J].height,Ce,Ue,re[J].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,je,re[J].width,re[J].height,0,Ce,Ue,re[J].data);for(let Ee=0;Ee<ae.length;Ee++){const ht=ae[Ee].image[J].image;C?q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,Ee+1,0,0,ht.width,ht.height,Ce,Ue,ht.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,Ee+1,je,ht.width,ht.height,0,Ce,Ue,ht.data)}}else{C?q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,Ce,Ue,re[J]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,je,Ce,Ue,re[J]);for(let Ee=0;Ee<ae.length;Ee++){const De=ae[Ee];C?q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,Ee+1,0,0,Ce,Ue,De.image[J]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,Ee+1,je,Ce,Ue,De.image[J])}}}h(g)&&M(i.TEXTURE_CUBE_MAP),ne.__version=Q.version,g.onUpdate&&g.onUpdate(g)}S.__version=g.version}function Ae(S,g,F,Y,Q,ne){const oe=r.convert(F.format,F.colorSpace),j=r.convert(F.type),Z=y(F.internalFormat,oe,j,F.normalized,F.colorSpace),pe=n.get(g),_e=n.get(F);if(_e.__renderTarget=g,!pe.__hasExternalTextures){const re=Math.max(1,g.width>>ne),ie=Math.max(1,g.height>>ne);Q===i.TEXTURE_3D||Q===i.TEXTURE_2D_ARRAY?t.texImage3D(Q,ne,Z,re,ie,g.depth,0,oe,j,null):t.texImage2D(Q,ne,Z,re,ie,0,oe,j,null)}t.bindFramebuffer(i.FRAMEBUFFER,S),Ie(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Y,Q,_e.__webglTexture,0,ot(g)):(Q===i.TEXTURE_2D||Q>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Q<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,Y,Q,_e.__webglTexture,ne),t.bindFramebuffer(i.FRAMEBUFFER,null)}function Je(S,g,F){if(i.bindRenderbuffer(i.RENDERBUFFER,S),g.depthBuffer){const Y=g.depthTexture,Q=Y&&Y.isDepthTexture?Y.type:null,ne=N(g.stencilBuffer,Q),oe=g.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;Ie(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ot(g),ne,g.width,g.height):F?i.renderbufferStorageMultisample(i.RENDERBUFFER,ot(g),ne,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,ne,g.width,g.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,oe,i.RENDERBUFFER,S)}else{const Y=g.textures;for(let Q=0;Q<Y.length;Q++){const ne=Y[Q],oe=r.convert(ne.format,ne.colorSpace),j=r.convert(ne.type),Z=y(ne.internalFormat,oe,j,ne.normalized,ne.colorSpace);Ie(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ot(g),Z,g.width,g.height):F?i.renderbufferStorageMultisample(i.RENDERBUFFER,ot(g),Z,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,Z,g.width,g.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function ze(S,g,F){const Y=g.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,S),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Q=n.get(g.depthTexture);if(Q.__renderTarget=g,(!Q.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),Y){if(Q.__webglInit===void 0&&(Q.__webglInit=!0,g.depthTexture.addEventListener("dispose",D)),Q.__webglTexture===void 0){Q.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,Q.__webglTexture),Pe(i.TEXTURE_CUBE_MAP,g.depthTexture);const pe=r.convert(g.depthTexture.format),_e=r.convert(g.depthTexture.type);let re;g.depthTexture.format===gn?re=i.DEPTH_COMPONENT24:g.depthTexture.format===Gn&&(re=i.DEPTH24_STENCIL8);for(let ie=0;ie<6;ie++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,0,re,g.width,g.height,0,pe,_e,null)}}else $(g.depthTexture,0);const ne=Q.__webglTexture,oe=ot(g),j=Y?i.TEXTURE_CUBE_MAP_POSITIVE_X+F:i.TEXTURE_2D,Z=g.depthTexture.format===Gn?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(g.depthTexture.format===gn)Ie(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Z,j,ne,0,oe):i.framebufferTexture2D(i.FRAMEBUFFER,Z,j,ne,0);else if(g.depthTexture.format===Gn)Ie(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Z,j,ne,0,oe):i.framebufferTexture2D(i.FRAMEBUFFER,Z,j,ne,0);else throw new Error("Unknown depthTexture format")}function Ye(S){const g=n.get(S),F=S.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==S.depthTexture){const Y=S.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),Y){const Q=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,Y.removeEventListener("dispose",Q)};Y.addEventListener("dispose",Q),g.__depthDisposeCallback=Q}g.__boundDepthTexture=Y}if(S.depthTexture&&!g.__autoAllocateDepthBuffer)if(F)for(let Y=0;Y<6;Y++)ze(g.__webglFramebuffer[Y],S,Y);else{const Y=S.texture.mipmaps;Y&&Y.length>0?ze(g.__webglFramebuffer[0],S,0):ze(g.__webglFramebuffer,S,0)}else if(F){g.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[Y]),g.__webglDepthbuffer[Y]===void 0)g.__webglDepthbuffer[Y]=i.createRenderbuffer(),Je(g.__webglDepthbuffer[Y],S,!1);else{const Q=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ne=g.__webglDepthbuffer[Y];i.bindRenderbuffer(i.RENDERBUFFER,ne),i.framebufferRenderbuffer(i.FRAMEBUFFER,Q,i.RENDERBUFFER,ne)}}else{const Y=S.texture.mipmaps;if(Y&&Y.length>0?t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=i.createRenderbuffer(),Je(g.__webglDepthbuffer,S,!1);else{const Q=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ne=g.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,ne),i.framebufferRenderbuffer(i.FRAMEBUFFER,Q,i.RENDERBUFFER,ne)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function Qe(S,g,F){const Y=n.get(S);g!==void 0&&Ae(Y.__webglFramebuffer,S,S.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),F!==void 0&&Ye(S)}function Oe(S){const g=S.texture,F=n.get(S),Y=n.get(g);S.addEventListener("dispose",v);const Q=S.textures,ne=S.isWebGLCubeRenderTarget===!0,oe=Q.length>1;if(oe||(Y.__webglTexture===void 0&&(Y.__webglTexture=i.createTexture()),Y.__version=g.version,a.memory.textures++),ne){F.__webglFramebuffer=[];for(let j=0;j<6;j++)if(g.mipmaps&&g.mipmaps.length>0){F.__webglFramebuffer[j]=[];for(let Z=0;Z<g.mipmaps.length;Z++)F.__webglFramebuffer[j][Z]=i.createFramebuffer()}else F.__webglFramebuffer[j]=i.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){F.__webglFramebuffer=[];for(let j=0;j<g.mipmaps.length;j++)F.__webglFramebuffer[j]=i.createFramebuffer()}else F.__webglFramebuffer=i.createFramebuffer();if(oe)for(let j=0,Z=Q.length;j<Z;j++){const pe=n.get(Q[j]);pe.__webglTexture===void 0&&(pe.__webglTexture=i.createTexture(),a.memory.textures++)}if(S.samples>0&&Ie(S)===!1){F.__webglMultisampledFramebuffer=i.createFramebuffer(),F.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let j=0;j<Q.length;j++){const Z=Q[j];F.__webglColorRenderbuffer[j]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,F.__webglColorRenderbuffer[j]);const pe=r.convert(Z.format,Z.colorSpace),_e=r.convert(Z.type),re=y(Z.internalFormat,pe,_e,Z.normalized,Z.colorSpace,S.isXRRenderTarget===!0),ie=ot(S);i.renderbufferStorageMultisample(i.RENDERBUFFER,ie,re,S.width,S.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+j,i.RENDERBUFFER,F.__webglColorRenderbuffer[j])}i.bindRenderbuffer(i.RENDERBUFFER,null),S.depthBuffer&&(F.__webglDepthRenderbuffer=i.createRenderbuffer(),Je(F.__webglDepthRenderbuffer,S,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(ne){t.bindTexture(i.TEXTURE_CUBE_MAP,Y.__webglTexture),Pe(i.TEXTURE_CUBE_MAP,g);for(let j=0;j<6;j++)if(g.mipmaps&&g.mipmaps.length>0)for(let Z=0;Z<g.mipmaps.length;Z++)Ae(F.__webglFramebuffer[j][Z],S,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Z);else Ae(F.__webglFramebuffer[j],S,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0);h(g)&&M(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(oe){for(let j=0,Z=Q.length;j<Z;j++){const pe=Q[j],_e=n.get(pe);let re=i.TEXTURE_2D;(S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(re=S.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(re,_e.__webglTexture),Pe(re,pe),Ae(F.__webglFramebuffer,S,pe,i.COLOR_ATTACHMENT0+j,re,0),h(pe)&&M(re)}t.unbindTexture()}else{let j=i.TEXTURE_2D;if((S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(j=S.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(j,Y.__webglTexture),Pe(j,g),g.mipmaps&&g.mipmaps.length>0)for(let Z=0;Z<g.mipmaps.length;Z++)Ae(F.__webglFramebuffer[Z],S,g,i.COLOR_ATTACHMENT0,j,Z);else Ae(F.__webglFramebuffer,S,g,i.COLOR_ATTACHMENT0,j,0);h(g)&&M(j),t.unbindTexture()}S.depthBuffer&&Ye(S)}function ut(S){const g=S.textures;for(let F=0,Y=g.length;F<Y;F++){const Q=g[F];if(h(Q)){const ne=T(S),oe=n.get(Q).__webglTexture;t.bindTexture(ne,oe),M(ne),t.unbindTexture()}}}const at=[],At=[];function P(S){if(S.samples>0){if(Ie(S)===!1){const g=S.textures,F=S.width,Y=S.height;let Q=i.COLOR_BUFFER_BIT;const ne=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,oe=n.get(S),j=g.length>1;if(j)for(let pe=0;pe<g.length;pe++)t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+pe,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+pe,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,oe.__webglMultisampledFramebuffer);const Z=S.texture.mipmaps;Z&&Z.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,oe.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,oe.__webglFramebuffer);for(let pe=0;pe<g.length;pe++){if(S.resolveDepthBuffer&&(S.depthBuffer&&(Q|=i.DEPTH_BUFFER_BIT),S.stencilBuffer&&S.resolveStencilBuffer&&(Q|=i.STENCIL_BUFFER_BIT)),j){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,oe.__webglColorRenderbuffer[pe]);const _e=n.get(g[pe]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,_e,0)}i.blitFramebuffer(0,0,F,Y,0,0,F,Y,Q,i.NEAREST),l===!0&&(at.length=0,At.length=0,at.push(i.COLOR_ATTACHMENT0+pe),S.depthBuffer&&S.resolveDepthBuffer===!1&&(at.push(ne),At.push(ne),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,At)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,at))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),j)for(let pe=0;pe<g.length;pe++){t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+pe,i.RENDERBUFFER,oe.__webglColorRenderbuffer[pe]);const _e=n.get(g[pe]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+pe,i.TEXTURE_2D,_e,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,oe.__webglMultisampledFramebuffer)}else if(S.depthBuffer&&S.resolveDepthBuffer===!1&&l){const g=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[g])}}}function ot(S){return Math.min(s.maxSamples,S.samples)}function Ie(S){const g=n.get(S);return S.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function Ke(S){const g=a.render.frame;d.get(S)!==g&&(d.set(S,g),S.update())}function ue(S,g){const F=S.colorSpace,Y=S.format,Q=S.type;return S.isCompressedTexture===!0||S.isVideoTexture===!0||F!==ps&&F!==Rn&&(Ve.getTransfer(F)===Ze?(Y!==Wt||Q!==zt)&&we("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Xe("WebGLTextures: Unsupported texture color space:",F)),g}function lt(S){return typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement?(c.width=S.naturalWidth||S.width,c.height=S.naturalHeight||S.height):typeof VideoFrame<"u"&&S instanceof VideoFrame?(c.width=S.displayWidth,c.height=S.displayHeight):(c.width=S.width,c.height=S.height),c}this.allocateTextureUnit=G,this.resetTextureUnits=X,this.getTextureUnits=W,this.setTextureUnits=U,this.setTexture2D=$,this.setTexture2DArray=ee,this.setTexture3D=le,this.setTextureCube=ve,this.rebindTextures=Qe,this.setupRenderTarget=Oe,this.updateRenderTargetMipmap=ut,this.updateMultisampleRenderTarget=P,this.setupDepthRenderbuffer=Ye,this.setupFrameBufferTexture=Ae,this.useMultisampledRTT=Ie,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function hg(i,e){function t(n,s=Rn){let r;const a=Ve.getTransfer(s);if(n===zt)return i.UNSIGNED_BYTE;if(n===ea)return i.UNSIGNED_SHORT_4_4_4_4;if(n===ta)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Go)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Ho)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Bo)return i.BYTE;if(n===zo)return i.SHORT;if(n===Ai)return i.UNSIGNED_SHORT;if(n===Qr)return i.INT;if(n===nn)return i.UNSIGNED_INT;if(n===Jt)return i.FLOAT;if(n===mn)return i.HALF_FLOAT;if(n===Vo)return i.ALPHA;if(n===ko)return i.RGB;if(n===Wt)return i.RGBA;if(n===gn)return i.DEPTH_COMPONENT;if(n===Gn)return i.DEPTH_STENCIL;if(n===Wo)return i.RED;if(n===na)return i.RED_INTEGER;if(n===Vn)return i.RG;if(n===ia)return i.RG_INTEGER;if(n===sa)return i.RGBA_INTEGER;if(n===os||n===ls||n===cs||n===us)if(a===Ze)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===os)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===ls)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===cs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===us)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===os)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===ls)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===cs)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===us)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===_r||n===xr||n===vr||n===Sr)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===_r)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===xr)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===vr)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Sr)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Mr||n===Er||n===br||n===yr||n===Tr||n===ds||n===Ar)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Mr||n===Er)return a===Ze?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===br)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===yr)return r.COMPRESSED_R11_EAC;if(n===Tr)return r.COMPRESSED_SIGNED_R11_EAC;if(n===ds)return r.COMPRESSED_RG11_EAC;if(n===Ar)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===wr||n===Rr||n===Cr||n===Pr||n===Nr||n===Dr||n===Lr||n===Ur||n===Ir||n===Fr||n===Or||n===Br||n===zr||n===Gr)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===wr)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Rr)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Cr)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Pr)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Nr)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Dr)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Lr)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Ur)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Ir)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Fr)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Or)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Br)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===zr)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Gr)return a===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Hr||n===Vr||n===kr)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Hr)return a===Ze?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Vr)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===kr)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Wr||n===Xr||n===fs||n===jr)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Wr)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Xr)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===fs)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===jr)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===wi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const dg=`
void main() {
...
}`;class pg{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new tl(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new Xt({vertexShader:dg,fragmentShader:fg,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new _n(new Ms(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class mg extends Wn{constructor(e,t){super();const n=this;let s=null,r=1,a=null,o="local-floor",l=1,c=null,d=null,p=null,u=null,m=null,_=null;const E=typeof XRWebGLBinding<"u",f=new pg,h={},M=t.getContextAttributes();let T=null,y=null;const N=[],b=[],D=new qe;let v=null;const A=new Bt;A.viewport=new pt;const I=new Bt;I.viewport=new pt;const R=[A,I],O=new yh;let X=null,W=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(K){let ce=N[K];return ce===void 0&&(ce=new Fs,N[K]=ce),ce.getTargetRaySpace()},this.getControllerGrip=function(K){let ce=N[K];return ce===void 0&&(ce=new Fs,N[K]=ce),ce.getGripSpace()},this.getHand=function(K){let ce=N[K];return ce===void 0&&(ce=new Fs,N[K]=ce),ce.getHandSpace()};function U(K){const ce=b.indexOf(K.inputSource);if(ce===-1)return;const te=N[ce];te!==void 0&&(te.update(K.inputSource,K.frame,c||a),te.dispatchEvent({type:K.type,data:K.inputSource}))}function G(){s.removeEventListener("select",U),s.removeEventListener("selectstart",U),s.removeEventListener("selectend",U),s.removeEventListener("squeeze",U),s.removeEventListener("squeezestart",U),s.removeEventListener("squeezeend",U),s.removeEventListener("end",G),s.removeEventListener("inputsourceschange",V);for(let K=0;K<N.length;K++){const ce=b[K];ce!==null&&(b[K]=null,N[K].disconnect(ce))}X=null,W=null,f.reset();for(const K in h)delete h[K];e.setRenderTarget(T),m=null,u=null,p=null,s=null,y=null,Pe.stop(),n.isPresenting=!1,e.setPixelRatio(v),e.setSize(D.width,D.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(K){r=K,n.isPresenting===!0&&we("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(K){o=K,n.isPresenting===!0&&we("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(K){c=K},this.getBaseLayer=function(){return u!==null?u:m},this.getBinding=function(){return p===null&&E&&(p=new XRWebGLBinding(s,t)),p},this.getFrame=function(){return _},this.getSession=function(){return s},this.setSession=async function(K){if(s=K,s!==null){if(T=e.getRenderTarget(),s.addEventListener("select",U),s.addEventListener("selectstart",U),s.addEventListener("selectend",U),s.addEventListener("squeeze",U),s.addEventListener("squeezestart",U),s.addEventListener("squeezeend",U),s.addEventListener("end",G),s.addEventListener("inputsourceschange",V),M.xrCompatible!==!0&&await t.makeXRCompatible(),v=e.getPixelRatio(),e.getSize(D),E&&"createProjectionLayer"in XRWebGLBinding.prototype){let te=null,Te=null,Re=null;M.depth&&(Re=M.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,te=M.stencil?Gn:gn,Te=M.stencil?wi:nn);const Ae={colorFormat:t.RGBA8,depthFormat:Re,scaleFactor:r};p=this.getBinding(),u=p.createProjectionLayer(Ae),s.updateRenderState({layers:[u]}),e.setPixelRatio(1),e.setSize(u.textureWidth,u.textureHeight,!1),y=new tn(u.textureWidth,u.textureHeight,{format:Wt,type:zt,depthTexture:new di(u.textureWidth,u.textureHeight,Te,void 0,void 0,void 0,void 0,void 0,void 0,te),stencilBuffer:M.stencil,colorSpace:e.outputColorSpace,samples:M.antialias?4:0,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1})}else{const te={antialias:M.antialias,alpha:!0,depth:M.depth,stencil:M.stencil,framebufferScaleFactor:r};m=new XRWebGLLayer(s,t,te),s.updateRenderState({baseLayer:m}),e.setPixelRatio(1),e.setSize(m.framebufferWidth,m.framebufferHeight,!1),y=new tn(m.framebufferWidth,m.framebufferHeight,{format:Wt,type:zt,colorSpace:e.outputColorSpace,stencilBuffer:M.stencil,resolveDepthBuffer:m.ignoreDepthValues===!1,resolveStencilBuffer:m.ignoreDepthValues===!1})}y.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await s.requestReferenceSpace(o),Pe.setContext(s),Pe.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return f.getDepthTexture()};function V(K){for(let ce=0;ce<K.removed.length;ce++){const te=K.removed[ce],Te=b.indexOf(te);Te>=0&&(b[Te]=null,N[Te].disconnect(te))}for(let ce=0;ce<K.added.length;ce++){const te=K.added[ce];let Te=b.indexOf(te);if(Te===-1){for(let Ae=0;Ae<N.length;Ae++)if(Ae>=b.length){b.push(te),Te=Ae;break}else if(b[Ae]===null){b[Ae]=te,Te=Ae;break}if(Te===-1)break}const Re=N[Te];Re&&Re.connect(te)}}const $=new H,ee=new H;function le(K,ce,te){$.setFromMatrixPosition(ce.matrixWorld),ee.setFromMatrixPosition(te.matrixWorld);const Te=$.distanceTo(ee),Re=ce.projectionMatrix.elements,Ae=te.projectionMatrix.elements,Je=Re[14]/(Re[10]-1),ze=Re[14]/(Re[10]+1),Ye=(Re[9]+1)/Re[5],Qe=(Re[9]-1)/Re[5],Oe=(Re[8]-1)/Re[0],ut=(Ae[8]+1)/Ae[0],at=Je*Oe,At=Je*ut,P=Te/(-Oe+ut),ot=P*-Oe;if(ce.matrixWorld.decompose(K.position,K.quaternion,K.scale),K.translateX(ot),K.translateZ(P),K.matrixWorld.compose(K.position,K.quaternion,K.scale),K.matrixWorldInverse.copy(K.matrixWorld).invert(),Re[10]===-1)K.projectionMatrix.copy(ce.projectionMatrix),K.projectionMatrixInverse.copy(ce.projectionMatrixInverse);else{const Ie=Je+P,Ke=ze+P,ue=at-ot,lt=At+(Te-ot),S=Ye*ze/Ke*Ie,g=Qe*ze/Ke*Ie;K.projectionMatrix.makePerspective(ue,lt,S,g,Ie,Ke),K.projectionMatrixInverse.copy(K.projectionMatrix).invert()}}function ve(K,ce){ce===null?K.matrixWorld.copy(K.matrix):K.matrixWorld.multiplyMatrices(ce.matrixWorld,K.matrix),K.matrixWorldInverse.copy(K.matrixWorld).invert()}this.updateCamera=function(K){if(s===null)return;let ce=K.near,te=K.far;f.texture!==null&&(f.depthNear>0&&(ce=f.depthNear),f.depthFar>0&&(te=f.depthFar)),O.near=I.near=A.near=ce,O.far=I.far=A.far=te,(X!==O.near||W!==O.far)&&(s.updateRenderState({depthNear:O.near,depthFar:O.far}),X=O.near,W=O.far),O.layers.mask=K.layers.mask|6,A.layers.mask=O.layers.mask&-5,I.layers.mask=O.layers.mask&-3;const Te=K.parent,Re=O.cameras;ve(O,Te);for(let Ae=0;Ae<Re.length;Ae++)ve(Re[Ae],Te);Re.length===2?le(O,A,I):O.projectionMatrix.copy(A.projectionMatrix),Me(K,O,Te)};function Me(K,ce,te){te===null?K.matrix.copy(ce.matrixWorld):(K.matrix.copy(te.matrixWorld),K.matrix.invert(),K.matrix.multiply(ce.matrixWorld)),K.matrix.decompose(K.position,K.quaternion,K.scale),K.updateMatrixWorld(!0),K.projectionMatrix.copy(ce.projectionMatrix),K.projectionMatrixInverse.copy(ce.projectionMatrixInverse),K.isPerspectiveCamera&&(K.fov=Yr*2*Math.atan(1/K.projectionMatrix.elements[5]),K.zoom=1)}this.getCamera=function(){return O},this.getFoveation=function(){if(!(u===null&&m===null))return l},this.setFoveation=function(K){l=K,u!==null&&(u.fixedFoveation=K),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=K)},this.hasDepthSensing=function(){return f.texture!==null},this.getDepthSensingMesh=function(){return f.getMesh(O)},this.getCameraTexture=function(K){return h[K]};let He=null;function Ge(K,ce){if(d=ce.getViewerPose(c||a),_=ce,d!==null){const te=d.views;m!==null&&(e.setRenderTargetFramebuffer(y,m.framebuffer),e.setRenderTarget(y));let Te=!1;te.length!==O.cameras.length&&(O.cameras.length=0,Te=!0);for(let ze=0;ze<te.length;ze++){const Ye=te[ze];let Qe=null;if(m!==null)Qe=m.getViewport(Ye);else{const ut=p.getViewSubImage(u,Ye);Qe=ut.viewport,ze===0&&(e.setRenderTargetTextures(y,ut.colorTexture,ut.depthStencilTexture),e.setRenderTarget(y))}let Oe=R[ze];Oe===void 0&&(Oe=new Bt,Oe.layers.enable(ze),Oe.viewport=new pt,R[ze]=Oe),Oe.matrix.fromArray(Ye.transform.matrix),Oe.matrix.decompose(Oe.position,Oe.quaternion,Oe.scale),Oe.projectionMatrix.fromArray(Ye.projectionMatrix),Oe.projectionMatrixInverse.copy(Oe.projectionMatrix).invert(),Oe.viewport.set(Qe.x,Qe.y,Qe.width,Qe.height),ze===0&&(O.matrix.copy(Oe.matrix),O.matrix.decompose(O.position,O.quaternion,O.scale)),Te===!0&&O.cameras.push(Oe)}const Re=s.enabledFeatures;if(Re&&Re.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&E){p=n.getBinding();const ze=p.getDepthInformation(te[0]);ze&&ze.isValid&&ze.texture&&f.init(ze,s.renderState)}if(Re&&Re.includes("camera-access")&&E){e.state.unbindTexture(),p=n.getBinding();for(let ze=0;ze<te.length;ze++){const Ye=te[ze].camera;if(Ye){let Qe=h[Ye];Qe||(Qe=new tl,h[Ye]=Qe);const Oe=p.getCameraImage(Ye);Qe.sourceTexture=Oe}}}}for(let te=0;te<N.length;te++){const Te=b[te],Re=N[te];Te!==null&&Re!==void 0&&Re.update(Te,ce,c||a)}He&&He(K,ce),ce.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:ce}),_=null}const Pe=new rl;Pe.setAnimationLoop(Ge),this.setAnimationLoop=function(K){He=K},this.dispose=function(){}}}const gg=new gt,dl=new Ne;dl.set(-1,0,0,0,1,0,0,0,1);function _g(i,e){function t(f,h){f.matrixAutoUpdate===!0&&f.updateMatrix(),h.value.copy(f.matrix)}function n(f,h){h.color.getRGB(f.fogColor.value,nl(i)),h.isFog?(f.fogNear.value=h.near,f.fogFar.value=h.far):h.isFogExp2&&(f.fogDensity.value=h.density)}function s(f,h,M,T,y){h.isNodeMaterial?h.uniformsNeedUpdate=!1:h.isMeshBasicMaterial?r(f,h):h.isMeshLambertMaterial?(r(f,h),h.envMap&&(f.envMapIntensity.value=h.envMapIntensity)):h.isMeshToonMaterial?(r(f,h),p(f,h)):h.isMeshPhongMaterial?(r(f,h),d(f,h),h.envMap&&(f.envMapIntensity.value=h.envMapIntensity)):h.isMeshStandardMaterial?(r(f,h),u(f,h),h.isMeshPhysicalMaterial&&m(f,h,y)):h.isMeshMatcapMaterial?(r(f,h),_(f,h)):h.isMeshDepthMaterial?r(f,h):h.isMeshDistanceMaterial?(r(f,h),E(f,h)):h.isMeshNormalMaterial?r(f,h):h.isLineBasicMaterial?(a(f,h),h.isLineDashedMaterial&&o(f,h)):h.isPointsMaterial?l(f,h,M,T):h.isSpriteMaterial?c(f,h):h.isShadowMaterial?(f.color.value.copy(h.color),f.opacity.value=h.opacity):h.isShaderMaterial&&(h.uniformsNeedUpdate=!1)}function r(f,h){f.opacity.value=h.opacity,h.color&&f.diffuse.value.copy(h.color),h.emissive&&f.emissive.value.copy(h.emissive).multiplyScalar(h.emissiveIntensity),h.map&&(f.map.value=h.map,t(h.map,f.mapTransform)),h.alphaMap&&(f.alphaMap.value=h.alphaMap,t(h.alphaMap,f.alphaMapTransform)),h.bumpMap&&(f.bumpMap.value=h.bumpMap,t(h.bumpMap,f.bumpMapTransform),f.bumpScale.value=h.bumpScale,h.side===Pt&&(f.bumpScale.value*=-1)),h.normalMap&&(f.normalMap.value=h.normalMap,t(h.normalMap,f.normalMapTransform),f.normalScale.value.copy(h.normalScale),h.side===Pt&&f.normalScale.value.negate()),h.displacementMap&&(f.displacementMap.value=h.displacementMap,t(h.displacementMap,f.displacementMapTransform),f.displacementScale.value=h.displacementScale,f.displacementBias.value=h.displacementBias),h.emissiveMap&&(f.emissiveMap.value=h.emissiveMap,t(h.emissiveMap,f.emissiveMapTransform)),h.specularMap&&(f.specularMap.value=h.specularMap,t(h.specularMap,f.specularMapTransform)),h.alphaTest>0&&(f.alphaTest.value=h.alphaTest);const M=e.get(h),T=M.envMap,y=M.envMapRotation;T&&(f.envMap.value=T,f.envMapRotation.value.setFromMatrix4(gg.makeRotationFromEuler(y)).transpose(),T.isCubeTexture&&T.isRenderTargetTexture===!1&&f.envMapRotation.value.premultiply(dl),f.reflectivity.value=h.reflectivity,f.ior.value=h.ior,f.refractionRatio.value=h.refractionRatio),h.lightMap&&(f.lightMap.value=h.lightMap,f.lightMapIntensity.value=h.lightMapIntensity,t(h.lightMap,f.lightMapTransform)),h.aoMap&&(f.aoMap.value=h.aoMap,f.aoMapIntensity.value=h.aoMapIntensity,t(h.aoMap,f.aoMapTransform))}function a(f,h){f.diffuse.value.copy(h.color),f.opacity.value=h.opacity,h.map&&(f.map.value=h.map,t(h.map,f.mapTransform))}function o(f,h){f.dashSize.value=h.dashSize,f.totalSize.value=h.dashSize+h.gapSize,f.scale.value=h.scale}function l(f,h,M,T){f.diffuse.value.copy(h.color),f.opacity.value=h.opacity,f.size.value=h.size*M,f.scale.value=T*.5,h.map&&(f.map.value=h.map,t(h.map,f.uvTransform)),h.alphaMap&&(f.alphaMap.value=h.alphaMap,t(h.alphaMap,f.alphaMapTransform)),h.alphaTest>0&&(f.alphaTest.value=h.alphaTest)}function c(f,h){f.diffuse.value.copy(h.color),f.opacity.value=h.opacity,f.rotation.value=h.rotation,h.map&&(f.map.value=h.map,t(h.map,f.mapTransform)),h.alphaMap&&(f.alphaMap.value=h.alphaMap,t(h.alphaMap,f.alphaMapTransform)),h.alphaTest>0&&(f.alphaTest.value=h.alphaTest)}function d(f,h){f.specular.value.copy(h.specular),f.shininess.value=Math.max(h.shininess,1e-4)}function p(f,h){h.gradientMap&&(f.gradientMap.value=h.gradientMap)}function u(f,h){f.metalness.value=h.metalness,h.metalnessMap&&(f.metalnessMap.value=h.metalnessMap,t(h.metalnessMap,f.metalnessMapTransform)),f.roughness.value=h.roughness,h.roughnessMap&&(f.roughnessMap.value=h.roughnessMap,t(h.roughnessMap,f.roughnessMapTransform)),h.envMap&&(f.envMapIntensity.value=h.envMapIntensity)}function m(f,h,M){f.ior.value=h.ior,h.sheen>0&&(f.sheenColor.value.copy(h.sheenColor).multiplyScalar(h.sheen),f.sheenRoughness.value=h.sheenRoughness,h.sheenColorMap&&(f.sheenColorMap.value=h.sheenColorMap,t(h.sheenColorMap,f.sheenColorMapTransform)),h.sheenRoughnessMap&&(f.sheenRoughnessMap.value=h.sheenRoughnessMap,t(h.sheenRoughnessMap,f.sheenRoughnessMapTransform))),h.clearcoat>0&&(f.clearcoat.value=h.clearcoat,f.clearcoatRoughness.value=h.clearcoatRoughness,h.clearcoatMap&&(f.clearcoatMap.value=h.clearcoatMap,t(h.clearcoatMap,f.clearcoatMapTransform)),h.clearcoatRoughnessMap&&(f.clearcoatRoughnessMap.value=h.clearcoatRoughnessMap,t(h.clearcoatRoughnessMap,f.clearcoatRoughnessMapTransform)),h.clearcoatNormalMap&&(f.clearcoatNormalMap.value=h.clearcoatNormalMap,t(h.clearcoatNormalMap,f.clearcoatNormalMapTransform),f.clearcoatNormalScale.value.copy(h.clearcoatNormalScale),h.side===Pt&&f.clearcoatNormalScale.value.negate())),h.dispersion>0&&(f.dispersion.value=h.dispersion),h.iridescence>0&&(f.iridescence.value=h.iridescence,f.iridescenceIOR.value=h.iridescenceIOR,f.iridescenceThicknessMinimum.value=h.iridescenceThicknessRange[0],f.iridescenceThicknessMaximum.value=h.iridescenceThicknessRange[1],h.iridescenceMap&&(f.iridescenceMap.value=h.iridescenceMap,t(h.iridescenceMap,f.iridescenceMapTransform)),h.iridescenceThicknessMap&&(f.iridescenceThicknessMap.value=h.iridescenceThicknessMap,t(h.iridescenceThicknessMap,f.iridescenceThicknessMapTransform))),h.transmission>0&&(f.transmission.value=h.transmission,f.transmissionSamplerMap.value=M.texture,f.transmissionSamplerSize.value.set(M.width,M.height),h.transmissionMap&&(f.transmissionMap.value=h.transmissionMap,t(h.transmissionMap,f.transmissionMapTransform)),f.thickness.value=h.thickness,h.thicknessMap&&(f.thicknessMap.value=h.thicknessMap,t(h.thicknessMap,f.thicknessMapTransform)),f.attenuationDistance.value=h.attenuationDistance,f.attenuationColor.value.copy(h.attenuationColor)),h.anisotropy>0&&(f.anisotropyVector.value.set(h.anisotropy*Math.cos(h.anisotropyRotation),h.anisotropy*Math.sin(h.anisotropyRotation)),h.anisotropyMap&&(f.anisotropyMap.value=h.anisotropyMap,t(h.anisotropyMap,f.anisotropyMapTransform))),f.specularIntensity.value=h.specularIntensity,f.specularColor.value.copy(h.specularColor),h.specularColorMap&&(f.specularColorMap.value=h.specularColorMap,t(h.specularColorMap,f.specularColorMapTransform)),h.specularIntensityMap&&(f.specularIntensityMap.value=h.specularIntensityMap,t(h.specularIntensityMap,f.specularIntensityMapTransform))}function _(f,h){h.matcap&&(f.matcap.value=h.matcap)}function E(f,h){const M=e.get(h).light;f.referencePosition.value.setFromMatrixPosition(M.matrixWorld),f.nearDistance.value=M.shadow.camera.near,f.farDistance.value=M.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function xg(i,e,t,n){let s={},r={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(M,T){const y=T.program;n.uniformBlockBinding(M,y)}function c(M,T){let y=s[M.id];y===void 0&&(_(M),y=d(M),s[M.id]=y,M.addEventListener("dispose",f));const N=T.program;n.updateUBOMapping(M,N);const b=e.render.frame;r[M.id]!==b&&(u(M),r[M.id]=b)}function d(M){const T=p();M.__bindingPointIndex=T;const y=i.createBuffer(),N=M.__size,b=M.usage;return i.bindBuffer(i.UNIFORM_BUFFER,y),i.bufferData(i.UNIFORM_BUFFER,N,b),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,T,y),y}function p(){for(let M=0;M<o;M++)if(a.indexOf(M)===-1)return a.push(M),M;return Xe("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function u(M){const T=s[M.id],y=M.uniforms,N=M.__cache;i.bindBuffer(i.UNIFORM_BUFFER,T);for(let b=0,D=y.length;b<D;b++){const v=Array.isArray(y[b])?y[b]:[y[b]];for(let A=0,I=v.length;A<I;A++){const R=v[A];if(m(R,b,A,N)===!0){const O=R.__offset,X=Array.isArray(R.value)?R.value:[R.value];let W=0;for(let U=0;U<X.length;U++){const G=X[U],V=E(G);typeof G=="number"||typeof G=="boolean"?(R.__data[0]=G,i.bufferSubData(i.UNIFORM_BUFFER,O+W,R.__data)):G.isMatrix3?(R.__data[0]=G.elements[0],R.__data[1]=G.elements[1],R.__data[2]=G.elements[2],R.__data[3]=0,R.__data[4]=G.elements[3],R.__data[5]=G.elements[4],R.__data[6]=G.elements[5],R.__data[7]=0,R.__data[8]=G.elements[6],R.__data[9]=G.elements[7],R.__data[10]=G.elements[8],R.__data[11]=0):ArrayBuffer.isView(G)?R.__data.set(new G.constructor(G.buffer,G.byteOffset,R.__data.length)):(G.toArray(R.__data,W),W+=V.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,O,R.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function m(M,T,y,N){const b=M.value,D=T+"_"+y;if(N[D]===void 0)return typeof b=="number"||typeof b=="boolean"?N[D]=b:ArrayBuffer.isView(b)?N[D]=b.slice():N[D]=b.clone(),!0;{const v=N[D];if(typeof b=="number"||typeof b=="boolean"){if(v!==b)return N[D]=b,!0}else{if(ArrayBuffer.isView(b))return!0;if(v.equals(b)===!1)return v.copy(b),!0}}return!1}function _(M){const T=M.uniforms;let y=0;const N=16;for(let D=0,v=T.length;D<v;D++){const A=Array.isArray(T[D])?T[D]:[T[D]];for(let I=0,R=A.length;I<R;I++){const O=A[I],X=Array.isArray(O.value)?O.value:[O.value];for(let W=0,U=X.length;W<U;W++){const G=X[W],V=E(G),$=y%N,ee=$%V.boundary,le=$+ee;y+=ee,le!==0&&N-le<V.storage&&(y+=N-le),O.__data=new Float32Array(V.storage/Float32Array.BYTES_PER_ELEMENT),O.__offset=y,y+=V.storage}}}const b=y%N;return b>0&&(y+=N-b),M.__size=y,M.__cache={},this}function E(M){const T={boundary:0,storage:0};return typeof M=="number"||typeof M=="boolean"?(T.boundary=4,T.storage=4):M.isVector2?(T.boundary=8,T.storage=8):M.isVector3||M.isColor?(T.boundary=16,T.storage=12):M.isVector4?(T.boundary=16,T.storage=16):M.isMatrix3?(T.boundary=48,T.storage=48):M.isMatrix4?(T.boundary=64,T.storage=64):M.isTexture?we("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(M)?(T.boundary=16,T.storage=M.byteLength):we("WebGLRenderer: Unsupported uniform value type.",M),T}function f(M){const T=M.target;T.removeEventListener("dispose",f);const y=a.indexOf(T.__bindingPointIndex);a.splice(y,1),i.deleteBuffer(s[T.id]),delete s[T.id],delete r[T.id]}function h(){for(const M in s)i.deleteBuffer(s[M]);a=[],s={},r={}}return{bind:l,update:c,dispose:h}}const vg=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let Zt=null;function Sg(){return Zt===null&&(Zt=new ch(vg,16,16,Vn,mn),Zt.name="DFG_LUT",Zt.minFilter=Tt,Zt.magFilter=Tt,Zt.wrapS=hn,Zt.wrapT=hn,Zt.generateMipmaps=!1,Zt.needsUpdate=!0),Zt}class Mg{constructor(e={}){const{canvas:t=Gu(),context:n=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:d="default",failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:u=!1,outputBufferType:m=zt}=e;this.isWebGLRenderer=!0;let _;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");_=n.getContextAttributes().alpha}else _=a;const E=m,f=new Set([sa,ia,na]),h=new Set([zt,nn,Ai,wi,ea,ta]),M=new Uint32Array(4),T=new Int32Array(4),y=new H;let N=null,b=null;const D=[],v=[];let A=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=en,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const I=this;let R=!1,O=null;this._outputColorSpace=Ot;let X=0,W=0,U=null,G=-1,V=null;const $=new pt,ee=new pt;let le=null;const ve=new $e(0);let Me=0,He=t.width,Ge=t.height,Pe=1,K=null,ce=null;const te=new pt(0,0,He,Ge),Te=new pt(0,0,He,Ge);let Re=!1;const Ae=new Qo;let Je=!1,ze=!1;const Ye=new gt,Qe=new H,Oe=new pt,ut={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let at=!1;function At(){return U===null?Pe:1}let P=n;function ot(x,L){return t.getContext(x,L)}try{const x={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:d,failIfMajorPerformanceCaveat:p};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Jr}`),t.addEventListener("webglcontextlost",J,!1),t.addEventListener("webglcontextrestored",Ee,!1),t.addEventListener("webglcontextcreationerror",De,!1),P===null){const L="webgl2";if(P=ot(L,x),P===null)throw ot(L)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(x){throw Xe("WebGLRenderer: "+x.message),x}let Ie,Ke,ue,lt,S,g,F,Y,Q,ne,oe,j,Z,pe,_e,re,ie,Ce,Ue,je,C,se,q;function me(){Ie=new Sp(P),Ie.init(),C=new hg(P,Ie),Ke=new dp(P,Ie,e,C),ue=new cg(P,Ie),Ke.reversedDepthBuffer&&u&&ue.buffers.depth.setReversed(!0),lt=new bp(P),S=new Km,g=new ug(P,Ie,ue,S,Ke,C,lt),F=new vp(I),Y=new Ah(P),se=new up(P,Y),Q=new Mp(P,Y,lt,se),ne=new Tp(P,Q,Y,se,lt),Ce=new yp(P,Ke,g),_e=new fp(S),oe=new Ym(I,F,Ie,Ke,se,_e),j=new _g(I,S),Z=new $m,pe=new ig(Ie),ie=new cp(I,F,ue,ne,_,l),re=new lg(I,ne,Ke),q=new xg(P,lt,Ke,ue),Ue=new hp(P,Ie,lt),je=new Ep(P,Ie,lt),lt.programs=oe.programs,I.capabilities=Ke,I.extensions=Ie,I.properties=S,I.renderLists=Z,I.shadowMap=re,I.state=ue,I.info=lt}me(),E!==zt&&(A=new wp(E,t.width,t.height,s,r));const ae=new mg(I,P);this.xr=ae,this.getContext=function(){return P},this.getContextAttributes=function(){return P.getContextAttributes()},this.forceContextLoss=function(){const x=Ie.get("WEBGL_lose_context");x&&x.loseContext()},this.forceContextRestore=function(){const x=Ie.get("WEBGL_lose_context");x&&x.restoreContext()},this.getPixelRatio=function(){return Pe},this.setPixelRatio=function(x){x!==void 0&&(Pe=x,this.setSize(He,Ge,!1))},this.getSize=function(x){return x.set(He,Ge)},this.setSize=function(x,L,k=!0){if(ae.isPresenting){we("WebGLRenderer: Can't change size while VR device is presenting.");return}He=x,Ge=L,t.width=Math.floor(x*Pe),t.height=Math.floor(L*Pe),k===!0&&(t.style.width=x+"px",t.style.height=L+"px"),A!==null&&A.setSize(t.width,t.height),this.setViewport(0,0,x,L)},this.getDrawingBufferSize=function(x){return x.set(He*Pe,Ge*Pe).floor()},this.setDrawingBufferSize=function(x,L,k){He=x,Ge=L,Pe=k,t.width=Math.floor(x*k),t.height=Math.floor(L*k),this.setViewport(0,0,x,L)},this.setEffects=function(x){if(E===zt){Xe("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(x){for(let L=0;L<x.length;L++)if(x[L].isOutputPass===!0){we("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}A.setEffects(x||[])},this.getCurrentViewport=function(x){return x.copy($)},this.getViewport=function(x){return x.copy(te)},this.setViewport=function(x,L,k,B){x.isVector4?te.set(x.x,x.y,x.z,x.w):te.set(x,L,k,B),ue.viewport($.copy(te).multiplyScalar(Pe).round())},this.getScissor=function(x){return x.copy(Te)},this.setScissor=function(x,L,k,B){x.isVector4?Te.set(x.x,x.y,x.z,x.w):Te.set(x,L,k,B),ue.scissor(ee.copy(Te).multiplyScalar(Pe).round())},this.getScissorTest=function(){return Re},this.setScissorTest=function(x){ue.setScissorTest(Re=x)},this.setOpaqueSort=function(x){K=x},this.setTransparentSort=function(x){ce=x},this.getClearColor=function(x){return x.copy(ie.getClearColor())},this.setClearColor=function(){ie.setClearColor(...arguments)},this.getClearAlpha=function(){return ie.getClearAlpha()},this.setClearAlpha=function(){ie.setClearAlpha(...arguments)},this.clear=function(x=!0,L=!0,k=!0){let B=0;if(x){let z=!1;if(U!==null){const fe=U.texture.format;z=f.has(fe)}if(z){const fe=U.texture.type,xe=h.has(fe),de=ie.getClearColor(),Se=ie.getClearAlpha(),be=de.r,Le=de.g,Be=de.b;xe?(M[0]=be,M[1]=Le,M[2]=Be,M[3]=Se,P.clearBufferuiv(P.COLOR,0,M)):(T[0]=be,T[1]=Le,T[2]=Be,T[3]=Se,P.clearBufferiv(P.COLOR,0,T))}else B|=P.COLOR_BUFFER_BIT}L&&(B|=P.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),k&&(B|=P.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),B!==0&&P.clear(B)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(x){x.setRenderer(this),O=x},this.dispose=function(){t.removeEventListener("webglcontextlost",J,!1),t.removeEventListener("webglcontextrestored",Ee,!1),t.removeEventListener("webglcontextcreationerror",De,!1),ie.dispose(),Z.dispose(),pe.dispose(),S.dispose(),F.dispose(),ne.dispose(),se.dispose(),q.dispose(),oe.dispose(),ae.dispose(),ae.removeEventListener("sessionstart",pa),ae.removeEventListener("sessionend",ma),Nn.stop()};function J(x){x.preventDefault(),La("WebGLRenderer: Context Lost."),R=!0}function Ee(){La("WebGLRenderer: Context Restored."),R=!1;const x=lt.autoReset,L=re.enabled,k=re.autoUpdate,B=re.needsUpdate,z=re.type;me(),lt.autoReset=x,re.enabled=L,re.autoUpdate=k,re.needsUpdate=B,re.type=z}function De(x){Xe("WebGLRenderer: A WebGL context could not be created. Reason: ",x.statusMessage)}function ht(x){const L=x.target;L.removeEventListener("dispose",ht),et(L)}function et(x){sn(x),S.remove(x)}function sn(x){const L=S.get(x).programs;L!==void 0&&(L.forEach(function(k){oe.releaseProgram(k)}),x.isShaderMaterial&&oe.releaseShaderCache(x))}this.renderBufferDirect=function(x,L,k,B,z,fe){L===null&&(L=ut);const xe=z.isMesh&&z.matrixWorld.determinant()<0,de=xl(x,L,k,B,z);ue.setMaterial(B,xe);let Se=k.index,be=1;if(B.wireframe===!0){if(Se=Q.getWireframeAttribute(k),Se===void 0)return;be=2}const Le=k.drawRange,Be=k.attributes.position;let ye=Le.start*be,tt=(Le.start+Le.count)*be;fe!==null&&(ye=Math.max(ye,fe.start*be),tt=Math.min(tt,(fe.start+fe.count)*be)),Se!==null?(ye=Math.max(ye,0),tt=Math.min(tt,Se.count)):Be!=null&&(ye=Math.max(ye,0),tt=Math.min(tt,Be.count));const dt=tt-ye;if(dt<0||dt===1/0)return;se.setup(z,B,de,k,Se);let ct,nt=Ue;if(Se!==null&&(ct=Y.get(Se),nt=je,nt.setIndex(ct)),z.isMesh)B.wireframe===!0?(ue.setLineWidth(B.wireframeLinewidth*At()),nt.setMode(P.LINES)):nt.setMode(P.TRIANGLES);else if(z.isLine){let Mt=B.linewidth;Mt===void 0&&(Mt=1),ue.setLineWidth(Mt*At()),z.isLineSegments?nt.setMode(P.LINES):z.isLineLoop?nt.setMode(P.LINE_LOOP):nt.setMode(P.LINE_STRIP)}else z.isPoints?nt.setMode(P.POINTS):z.isSprite&&nt.setMode(P.TRIANGLES);if(z.isBatchedMesh)if(Ie.get("WEBGL_multi_draw"))nt.renderMultiDraw(z._multiDrawStarts,z._multiDrawCounts,z._multiDrawCount);else{const Mt=z._multiDrawStarts,ge=z._multiDrawCounts,Dt=z._multiDrawCount,We=Se?Y.get(Se).bytesPerElement:1,It=S.get(B).currentProgram.getUniforms();for(let Yt=0;Yt<Dt;Yt++)It.setValue(P,"_gl_DrawID",Yt),nt.render(Mt[Yt]/We,ge[Yt])}else if(z.isInstancedMesh)nt.renderInstances(ye,dt,z.count);else if(k.isInstancedBufferGeometry){const Mt=k._maxInstanceCount!==void 0?k._maxInstanceCount:1/0,ge=Math.min(k.instanceCount,Mt);nt.renderInstances(ye,dt,ge)}else nt.render(ye,dt)};function qt(x,L,k){x.transparent===!0&&x.side===un&&x.forceSinglePass===!1?(x.side=Pt,x.needsUpdate=!0,Li(x,L,k),x.side=Pn,x.needsUpdate=!0,Li(x,L,k),x.side=un):Li(x,L,k)}this.compile=function(x,L,k=null){k===null&&(k=x),b=pe.get(k),b.init(L),v.push(b),k.traverseVisible(function(z){z.isLight&&z.layers.test(L.layers)&&(b.pushLight(z),z.castShadow&&b.pushShadow(z))}),x!==k&&x.traverseVisible(function(z){z.isLight&&z.layers.test(L.layers)&&(b.pushLight(z),z.castShadow&&b.pushShadow(z))}),b.setupLights();const B=new Set;return x.traverse(function(z){if(!(z.isMesh||z.isPoints||z.isLine||z.isSprite))return;const fe=z.material;if(fe)if(Array.isArray(fe))for(let xe=0;xe<fe.length;xe++){const de=fe[xe];qt(de,k,z),B.add(de)}else qt(fe,k,z),B.add(fe)}),b=v.pop(),B},this.compileAsync=function(x,L,k=null){const B=this.compile(x,L,k);return new Promise(z=>{function fe(){if(B.forEach(function(xe){S.get(xe).currentProgram.isReady()&&B.delete(xe)}),B.size===0){z(x);return}setTimeout(fe,10)}Ie.get("KHR_parallel_shader_compile")!==null?fe():setTimeout(fe,10)})};let ys=null;function gl(x){ys&&ys(x)}function pa(){Nn.stop()}function ma(){Nn.start()}const Nn=new rl;Nn.setAnimationLoop(gl),typeof self<"u"&&Nn.setContext(self),this.setAnimationLoop=function(x){ys=x,ae.setAnimationLoop(x),x===null?Nn.stop():Nn.start()},ae.addEventListener("sessionstart",pa),ae.addEventListener("sessionend",ma),this.render=function(x,L){if(L!==void 0&&L.isCamera!==!0){Xe("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(R===!0)return;O!==null&&O.renderStart(x,L);const k=ae.enabled===!0&&ae.isPresenting===!0,B=A!==null&&(U===null||k)&&A.begin(I,U);if(x.matrixWorldAutoUpdate===!0&&x.updateMatrixWorld(),L.parent===null&&L.matrixWorldAutoUpdate===!0&&L.updateMatrixWorld(),ae.enabled===!0&&ae.isPresenting===!0&&(A===null||A.isCompositing()===!1)&&(ae.cameraAutoUpdate===!0&&ae.updateCamera(L),L=ae.getCamera()),x.isScene===!0&&x.onBeforeRender(I,x,L,U),b=pe.get(x,v.length),b.init(L),b.state.textureUnits=g.getTextureUnits(),v.push(b),Ye.multiplyMatrices(L.projectionMatrix,L.matrixWorldInverse),Ae.setFromProjectionMatrix(Ye,Qt,L.reversedDepth),ze=this.localClippingEnabled,Je=_e.init(this.clippingPlanes,ze),N=Z.get(x,D.length),N.init(),D.push(N),ae.enabled===!0&&ae.isPresenting===!0){const xe=I.xr.getDepthSensingMesh();xe!==null&&Ts(xe,L,-1/0,I.sortObjects)}Ts(x,L,0,I.sortObjects),N.finish(),I.sortObjects===!0&&N.sort(K,ce),at=ae.enabled===!1||ae.isPresenting===!1||ae.hasDepthSensing()===!1,at&&ie.addToRenderList(N,x),this.info.render.frame++,Je===!0&&_e.beginShadows();const z=b.state.shadowsArray;if(re.render(z,x,L),Je===!0&&_e.endShadows(),this.info.autoReset===!0&&this.info.reset(),(B&&A.hasRenderPass())===!1){const xe=N.opaque,de=N.transmissive;if(b.setupLights(),L.isArrayCamera){const Se=L.cameras;if(de.length>0)for(let be=0,Le=Se.length;be<Le;be++){const Be=Se[be];_a(xe,de,x,Be)}at&&ie.render(x);for(let be=0,Le=Se.length;be<Le;be++){const Be=Se[be];ga(N,x,Be,Be.viewport)}}else de.length>0&&_a(xe,de,x,L),at&&ie.render(x),ga(N,x,L)}U!==null&&W===0&&(g.updateMultisampleRenderTarget(U),g.updateRenderTargetMipmap(U)),B&&A.end(I),x.isScene===!0&&x.onAfterRender(I,x,L),se.resetDefaultState(),G=-1,V=null,v.pop(),v.length>0?(b=v[v.length-1],g.setTextureUnits(b.state.textureUnits),Je===!0&&_e.setGlobalState(I.clippingPlanes,b.state.camera)):b=null,D.pop(),D.length>0?N=D[D.length-1]:N=null,O!==null&&O.renderEnd()};function Ts(x,L,k,B){if(x.visible===!1)return;if(x.layers.test(L.layers)){if(x.isGroup)k=x.renderOrder;else if(x.isLOD)x.autoUpdate===!0&&x.update(L);else if(x.isLightProbeGrid)b.pushLightProbeGrid(x);else if(x.isLight)b.pushLight(x),x.castShadow&&b.pushShadow(x);else if(x.isSprite){if(!x.frustumCulled||Ae.intersectsSprite(x)){B&&Oe.setFromMatrixPosition(x.matrixWorld).applyMatrix4(Ye);const xe=ne.update(x),de=x.material;de.visible&&N.push(x,xe,de,k,Oe.z,null)}}else if((x.isMesh||x.isLine||x.isPoints)&&(!x.frustumCulled||Ae.intersectsObject(x))){const xe=ne.update(x),de=x.material;if(B&&(x.boundingSphere!==void 0?(x.boundingSphere===null&&x.computeBoundingSphere(),Oe.copy(x.boundingSphere.center)):(xe.boundingSphere===null&&xe.computeBoundingSphere(),Oe.copy(xe.boundingSphere.center)),Oe.applyMatrix4(x.matrixWorld).applyMatrix4(Ye)),Array.isArray(de)){const Se=xe.groups;for(let be=0,Le=Se.length;be<Le;be++){const Be=Se[be],ye=de[Be.materialIndex];ye&&ye.visible&&N.push(x,xe,ye,k,Oe.z,Be)}}else de.visible&&N.push(x,xe,de,k,Oe.z,null)}}const fe=x.children;for(let xe=0,de=fe.length;xe<de;xe++)Ts(fe[xe],L,k,B)}function ga(x,L,k,B){const{opaque:z,transmissive:fe,transparent:xe}=x;b.setupLightsView(k),Je===!0&&_e.setGlobalState(I.clippingPlanes,k),B&&ue.viewport($.copy(B)),z.length>0&&Di(z,L,k),fe.length>0&&Di(fe,L,k),xe.length>0&&Di(xe,L,k),ue.buffers.depth.setTest(!0),ue.buffers.depth.setMask(!0),ue.buffers.color.setMask(!0),ue.setPolygonOffset(!1)}function _a(x,L,k,B){if((k.isScene===!0?k.overrideMaterial:null)!==null)return;if(b.state.transmissionRenderTarget[B.id]===void 0){const ye=Ie.has("EXT_color_buffer_half_float")||Ie.has("EXT_color_buffer_float");b.state.transmissionRenderTarget[B.id]=new tn(1,1,{generateMipmaps:!0,type:ye?mn:zt,minFilter:zn,samples:Math.max(4,Ke.samples),stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ve.workingColorSpace})}const fe=b.state.transmissionRenderTarget[B.id],xe=B.viewport||$;fe.setSize(xe.z*I.transmissionResolutionScale,xe.w*I.transmissionResolutionScale);const de=I.getRenderTarget(),Se=I.getActiveCubeFace(),be=I.getActiveMipmapLevel();I.setRenderTarget(fe),I.getClearColor(ve),Me=I.getClearAlpha(),Me<1&&I.setClearColor(16777215,.5),I.clear(),at&&ie.render(k);const Le=I.toneMapping;I.toneMapping=en;const Be=B.viewport;if(B.viewport!==void 0&&(B.viewport=void 0),b.setupLightsView(B),Je===!0&&_e.setGlobalState(I.clippingPlanes,B),Di(x,k,B),g.updateMultisampleRenderTarget(fe),g.updateRenderTargetMipmap(fe),Ie.has("WEBGL_multisampled_render_to_texture")===!1){let ye=!1;for(let tt=0,dt=L.length;tt<dt;tt++){const ct=L[tt],{object:nt,geometry:Mt,material:ge,group:Dt}=ct;if(ge.side===un&&nt.layers.test(B.layers)){const We=ge.side;ge.side=Pt,ge.needsUpdate=!0,xa(nt,k,B,Mt,ge,Dt),ge.side=We,ge.needsUpdate=!0,ye=!0}}ye===!0&&(g.updateMultisampleRenderTarget(fe),g.updateRenderTargetMipmap(fe))}I.setRenderTarget(de,Se,be),I.setClearColor(ve,Me),Be!==void 0&&(B.viewport=Be),I.toneMapping=Le}function Di(x,L,k){const B=L.isScene===!0?L.overrideMaterial:null;for(let z=0,fe=x.length;z<fe;z++){const xe=x[z],{object:de,geometry:Se,group:be}=xe;let Le=xe.material;Le.allowOverride===!0&&B!==null&&(Le=B),de.layers.test(k.layers)&&xa(de,L,k,Se,Le,be)}}function xa(x,L,k,B,z,fe){x.onBeforeRender(I,L,k,B,z,fe),x.modelViewMatrix.multiplyMatrices(k.matrixWorldInverse,x.matrixWorld),x.normalMatrix.getNormalMatrix(x.modelViewMatrix),z.onBeforeRender(I,L,k,B,x,fe),z.transparent===!0&&z.side===un&&z.forceSinglePass===!1?(z.side=Pt,z.needsUpdate=!0,I.renderBufferDirect(k,L,B,z,x,fe),z.side=Pn,z.needsUpdate=!0,I.renderBufferDirect(k,L,B,z,x,fe),z.side=un):I.renderBufferDirect(k,L,B,z,x,fe),x.onAfterRender(I,L,k,B,z,fe)}function Li(x,L,k){L.isScene!==!0&&(L=ut);const B=S.get(x),z=b.state.lights,fe=b.state.shadowsArray,xe=z.state.version,de=oe.getParameters(x,z.state,fe,L,k,b.state.lightProbeGridArray),Se=oe.getProgramCacheKey(de);let be=B.programs;B.environment=x.isMeshStandardMaterial||x.isMeshLambertMaterial||x.isMeshPhongMaterial?L.environment:null,B.fog=L.fog;const Le=x.isMeshStandardMaterial||x.isMeshLambertMaterial&&!x.envMap||x.isMeshPhongMaterial&&!x.envMap;B.envMap=F.get(x.envMap||B.environment,Le),B.envMapRotation=B.environment!==null&&x.envMap===null?L.environmentRotation:x.envMapRotation,be===void 0&&(x.addEventListener("dispose",ht),be=new Map,B.programs=be);let Be=be.get(Se);if(Be!==void 0){if(B.currentProgram===Be&&B.lightsStateVersion===xe)return Sa(x,de),Be}else de.uniforms=oe.getUniforms(x),O!==null&&x.isNodeMaterial&&O.build(x,k,de),x.onBeforeCompile(de,I),Be=oe.acquireProgram(de,Se),be.set(Se,Be),B.uniforms=de.uniforms;const ye=B.uniforms;return(!x.isShaderMaterial&&!x.isRawShaderMaterial||x.clipping===!0)&&(ye.clippingPlanes=_e.uniform),Sa(x,de),B.needsLights=Sl(x),B.lightsStateVersion=xe,B.needsLights&&(ye.ambientLightColor.value=z.state.ambient,ye.lightProbe.value=z.state.probe,ye.directionalLights.value=z.state.directional,ye.directionalLightShadows.value=z.state.directionalShadow,ye.spotLights.value=z.state.spot,ye.spotLightShadows.value=z.state.spotShadow,ye.rectAreaLights.value=z.state.rectArea,ye.ltc_1.value=z.state.rectAreaLTC1,ye.ltc_2.value=z.state.rectAreaLTC2,ye.pointLights.value=z.state.point,ye.pointLightShadows.value=z.state.pointShadow,ye.hemisphereLights.value=z.state.hemi,ye.directionalShadowMatrix.value=z.state.directionalShadowMatrix,ye.spotLightMatrix.value=z.state.spotLightMatrix,ye.spotLightMap.value=z.state.spotLightMap,ye.pointShadowMatrix.value=z.state.pointShadowMatrix),B.lightProbeGrid=b.state.lightProbeGridArray.length>0,B.currentProgram=Be,B.uniformsList=null,Be}function va(x){if(x.uniformsList===null){const L=x.currentProgram.getUniforms();x.uniformsList=hs.seqWithValue(L.seq,x.uniforms)}return x.uniformsList}function Sa(x,L){const k=S.get(x);k.outputColorSpace=L.outputColorSpace,k.batching=L.batching,k.batchingColor=L.batchingColor,k.instancing=L.instancing,k.instancingColor=L.instancingColor,k.instancingMorph=L.instancingMorph,k.skinning=L.skinning,k.morphTargets=L.morphTargets,k.morphNormals=L.morphNormals,k.morphColors=L.morphColors,k.morphTargetsCount=L.morphTargetsCount,k.numClippingPlanes=L.numClippingPlanes,k.numIntersection=L.numClipIntersection,k.vertexAlphas=L.vertexAlphas,k.vertexTangents=L.vertexTangents,k.toneMapping=L.toneMapping}function _l(x,L){if(x.length===0)return null;if(x.length===1)return x[0].texture!==null?x[0]:null;y.setFromMatrixPosition(L.matrixWorld);for(let k=0,B=x.length;k<B;k++){const z=x[k];if(z.texture!==null&&z.boundingBox.containsPoint(y))return z}return null}function xl(x,L,k,B,z){L.isScene!==!0&&(L=ut),g.resetTextureUnits();const fe=L.fog,xe=B.isMeshStandardMaterial||B.isMeshLambertMaterial||B.isMeshPhongMaterial?L.environment:null,de=U===null?I.outputColorSpace:U.isXRRenderTarget===!0?U.texture.colorSpace:Ve.workingColorSpace,Se=B.isMeshStandardMaterial||B.isMeshLambertMaterial&&!B.envMap||B.isMeshPhongMaterial&&!B.envMap,be=F.get(B.envMap||xe,Se),Le=B.vertexColors===!0&&!!k.attributes.color&&k.attributes.color.itemSize===4,Be=!!k.attributes.tangent&&(!!B.normalMap||B.anisotropy>0),ye=!!k.morphAttributes.position,tt=!!k.morphAttributes.normal,dt=!!k.morphAttributes.color;let ct=en;B.toneMapped&&(U===null||U.isXRRenderTarget===!0)&&(ct=I.toneMapping);const nt=k.morphAttributes.position||k.morphAttributes.normal||k.morphAttributes.color,Mt=nt!==void 0?nt.length:0,ge=S.get(B),Dt=b.state.lights;if(Je===!0&&(ze===!0||x!==V)){const rt=x===V&&B.id===G;_e.setState(B,x,rt)}let We=!1;B.version===ge.__version?(ge.needsLights&&ge.lightsStateVersion!==Dt.state.version||ge.outputColorSpace!==de||z.isBatchedMesh&&ge.batching===!1||!z.isBatchedMesh&&ge.batching===!0||z.isBatchedMesh&&ge.batchingColor===!0&&z.colorTexture===null||z.isBatchedMesh&&ge.batchingColor===!1&&z.colorTexture!==null||z.isInstancedMesh&&ge.instancing===!1||!z.isInstancedMesh&&ge.instancing===!0||z.isSkinnedMesh&&ge.skinning===!1||!z.isSkinnedMesh&&ge.skinning===!0||z.isInstancedMesh&&ge.instancingColor===!0&&z.instanceColor===null||z.isInstancedMesh&&ge.instancingColor===!1&&z.instanceColor!==null||z.isInstancedMesh&&ge.instancingMorph===!0&&z.morphTexture===null||z.isInstancedMesh&&ge.instancingMorph===!1&&z.morphTexture!==null||ge.envMap!==be||B.fog===!0&&ge.fog!==fe||ge.numClippingPlanes!==void 0&&(ge.numClippingPlanes!==_e.numPlanes||ge.numIntersection!==_e.numIntersection)||ge.vertexAlphas!==Le||ge.vertexTangents!==Be||ge.morphTargets!==ye||ge.morphNormals!==tt||ge.morphColors!==dt||ge.toneMapping!==ct||ge.morphTargetsCount!==Mt||!!ge.lightProbeGrid!=b.state.lightProbeGridArray.length>0)&&(We=!0):(We=!0,ge.__version=B.version);let It=ge.currentProgram;We===!0&&(It=Li(B,L,z),O&&B.isNodeMaterial&&O.onUpdateProgram(B,It,ge));let Yt=!1,xn=!1,Xn=!1;const it=It.getUniforms(),ft=ge.uniforms;if(ue.useProgram(It.program)&&(Yt=!0,xn=!0,Xn=!0),B.id!==G&&(G=B.id,xn=!0),ge.needsLights){const rt=_l(b.state.lightProbeGridArray,z);ge.lightProbeGrid!==rt&&(ge.lightProbeGrid=rt,xn=!0)}if(Yt||V!==x){ue.buffers.depth.getReversed()&&x.reversedDepth!==!0&&(x._reversedDepth=!0,x.updateProjectionMatrix()),it.setValue(P,"projectionMatrix",x.projectionMatrix),it.setValue(P,"viewMatrix",x.matrixWorldInverse);const Sn=it.map.cameraPosition;Sn!==void 0&&Sn.setValue(P,Qe.setFromMatrixPosition(x.matrixWorld)),Ke.logarithmicDepthBuffer&&it.setValue(P,"logDepthBufFC",2/(Math.log(x.far+1)/Math.LN2)),(B.isMeshPhongMaterial||B.isMeshToonMaterial||B.isMeshLambertMaterial||B.isMeshBasicMaterial||B.isMeshStandardMaterial||B.isShaderMaterial)&&it.setValue(P,"isOrthographic",x.isOrthographicCamera===!0),V!==x&&(V=x,xn=!0,Xn=!0)}if(ge.needsLights&&(Dt.state.directionalShadowMap.length>0&&it.setValue(P,"directionalShadowMap",Dt.state.directionalShadowMap,g),Dt.state.spotShadowMap.length>0&&it.setValue(P,"spotShadowMap",Dt.state.spotShadowMap,g),Dt.state.pointShadowMap.length>0&&it.setValue(P,"pointShadowMap",Dt.state.pointShadowMap,g)),z.isSkinnedMesh){it.setOptional(P,z,"bindMatrix"),it.setOptional(P,z,"bindMatrixInverse");const rt=z.skeleton;rt&&(rt.boneTexture===null&&rt.computeBoneTexture(),it.setValue(P,"boneTexture",rt.boneTexture,g))}z.isBatchedMesh&&(it.setOptional(P,z,"batchingTexture"),it.setValue(P,"batchingTexture",z._matricesTexture,g),it.setOptional(P,z,"batchingIdTexture"),it.setValue(P,"batchingIdTexture",z._indirectTexture,g),it.setOptional(P,z,"batchingColorTexture"),z._colorsTexture!==null&&it.setValue(P,"batchingColorTexture",z._colorsTexture,g));const vn=k.morphAttributes;if((vn.position!==void 0||vn.normal!==void 0||vn.color!==void 0)&&Ce.update(z,k,It),(xn||ge.receiveShadow!==z.receiveShadow)&&(ge.receiveShadow=z.receiveShadow,it.setValue(P,"receiveShadow",z.receiveShadow)),(B.isMeshStandardMaterial||B.isMeshLambertMaterial||B.isMeshPhongMaterial)&&B.envMap===null&&L.environment!==null&&(ft.envMapIntensity.value=L.environmentIntensity),ft.dfgLUT!==void 0&&(ft.dfgLUT.value=Sg()),xn){if(it.setValue(P,"toneMappingExposure",I.toneMappingExposure),ge.needsLights&&vl(ft,Xn),fe&&B.fog===!0&&j.refreshFogUniforms(ft,fe),j.refreshMaterialUniforms(ft,B,Pe,Ge,b.state.transmissionRenderTarget[x.id]),ge.needsLights&&ge.lightProbeGrid){const rt=ge.lightProbeGrid;ft.probesSH.value=rt.texture,ft.probesMin.value.copy(rt.boundingBox.min),ft.probesMax.value.copy(rt.boundingBox.max),ft.probesResolution.value.copy(rt.resolution)}hs.upload(P,va(ge),ft,g)}if(B.isShaderMaterial&&B.uniformsNeedUpdate===!0&&(hs.upload(P,va(ge),ft,g),B.uniformsNeedUpdate=!1),B.isSpriteMaterial&&it.setValue(P,"center",z.center),it.setValue(P,"modelViewMatrix",z.modelViewMatrix),it.setValue(P,"normalMatrix",z.normalMatrix),it.setValue(P,"modelMatrix",z.matrixWorld),B.uniformsGroups!==void 0){const rt=B.uniformsGroups;for(let Sn=0,jn=rt.length;Sn<jn;Sn++){const Ma=rt[Sn];q.update(Ma,It),q.bind(Ma,It)}}return It}function vl(x,L){x.ambientLightColor.needsUpdate=L,x.lightProbe.needsUpdate=L,x.directionalLights.needsUpdate=L,x.directionalLightShadows.needsUpdate=L,x.pointLights.needsUpdate=L,x.pointLightShadows.needsUpdate=L,x.spotLights.needsUpdate=L,x.spotLightShadows.needsUpdate=L,x.rectAreaLights.needsUpdate=L,x.hemisphereLights.needsUpdate=L}function Sl(x){return x.isMeshLambertMaterial||x.isMeshToonMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isShadowMaterial||x.isShaderMaterial&&x.lights===!0}this.getActiveCubeFace=function(){return X},this.getActiveMipmapLevel=function(){return W},this.getRenderTarget=function(){return U},this.setRenderTargetTextures=function(x,L,k){const B=S.get(x);B.__autoAllocateDepthBuffer=x.resolveDepthBuffer===!1,B.__autoAllocateDepthBuffer===!1&&(B.__useRenderToTexture=!1),S.get(x.texture).__webglTexture=L,S.get(x.depthTexture).__webglTexture=B.__autoAllocateDepthBuffer?void 0:k,B.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(x,L){const k=S.get(x);k.__webglFramebuffer=L,k.__useDefaultFramebuffer=L===void 0};const Ml=P.createFramebuffer();this.setRenderTarget=function(x,L=0,k=0){U=x,X=L,W=k;let B=null,z=!1,fe=!1;if(x){const de=S.get(x);if(de.__useDefaultFramebuffer!==void 0){ue.bindFramebuffer(P.FRAMEBUFFER,de.__webglFramebuffer),$.copy(x.viewport),ee.copy(x.scissor),le=x.scissorTest,ue.viewport($),ue.scissor(ee),ue.setScissorTest(le),G=-1;return}else if(de.__webglFramebuffer===void 0)g.setupRenderTarget(x);else if(de.__hasExternalTextures)g.rebindTextures(x,S.get(x.texture).__webglTexture,S.get(x.depthTexture).__webglTexture);else if(x.depthBuffer){const Le=x.depthTexture;if(de.__boundDepthTexture!==Le){if(Le!==null&&S.has(Le)&&(x.width!==Le.image.width||x.height!==Le.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");g.setupDepthRenderbuffer(x)}}const Se=x.texture;(Se.isData3DTexture||Se.isDataArrayTexture||Se.isCompressedArrayTexture)&&(fe=!0);const be=S.get(x).__webglFramebuffer;x.isWebGLCubeRenderTarget?(Array.isArray(be[L])?B=be[L][k]:B=be[L],z=!0):x.samples>0&&g.useMultisampledRTT(x)===!1?B=S.get(x).__webglMultisampledFramebuffer:Array.isArray(be)?B=be[k]:B=be,$.copy(x.viewport),ee.copy(x.scissor),le=x.scissorTest}else $.copy(te).multiplyScalar(Pe).floor(),ee.copy(Te).multiplyScalar(Pe).floor(),le=Re;if(k!==0&&(B=Ml),ue.bindFramebuffer(P.FRAMEBUFFER,B)&&ue.drawBuffers(x,B),ue.viewport($),ue.scissor(ee),ue.setScissorTest(le),z){const de=S.get(x.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_CUBE_MAP_POSITIVE_X+L,de.__webglTexture,k)}else if(fe){const de=L;for(let Se=0;Se<x.textures.length;Se++){const be=S.get(x.textures[Se]);P.framebufferTextureLayer(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0+Se,be.__webglTexture,k,de)}}else if(x!==null&&k!==0){const de=S.get(x.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,de.__webglTexture,k)}G=-1},this.readRenderTargetPixels=function(x,L,k,B,z,fe,xe,de=0){if(!(x&&x.isWebGLRenderTarget)){Xe("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Se=S.get(x).__webglFramebuffer;if(x.isWebGLCubeRenderTarget&&xe!==void 0&&(Se=Se[xe]),Se){ue.bindFramebuffer(P.FRAMEBUFFER,Se);try{const be=x.textures[de],Le=be.format,Be=be.type;if(x.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+de),!Ke.textureFormatReadable(Le)){Xe("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Ke.textureTypeReadable(Be)){Xe("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}L>=0&&L<=x.width-B&&k>=0&&k<=x.height-z&&P.readPixels(L,k,B,z,C.convert(Le),C.convert(Be),fe)}finally{const be=U!==null?S.get(U).__webglFramebuffer:null;ue.bindFramebuffer(P.FRAMEBUFFER,be)}}},this.readRenderTargetPixelsAsync=async function(x,L,k,B,z,fe,xe,de=0){if(!(x&&x.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Se=S.get(x).__webglFramebuffer;if(x.isWebGLCubeRenderTarget&&xe!==void 0&&(Se=Se[xe]),Se)if(L>=0&&L<=x.width-B&&k>=0&&k<=x.height-z){ue.bindFramebuffer(P.FRAMEBUFFER,Se);const be=x.textures[de],Le=be.format,Be=be.type;if(x.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+de),!Ke.textureFormatReadable(Le))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Ke.textureTypeReadable(Be))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const ye=P.createBuffer();P.bindBuffer(P.PIXEL_PACK_BUFFER,ye),P.bufferData(P.PIXEL_PACK_BUFFER,fe.byteLength,P.STREAM_READ),P.readPixels(L,k,B,z,C.convert(Le),C.convert(Be),0);const tt=U!==null?S.get(U).__webglFramebuffer:null;ue.bindFramebuffer(P.FRAMEBUFFER,tt);const dt=P.fenceSync(P.SYNC_GPU_COMMANDS_COMPLETE,0);return P.flush(),await Hu(P,dt,4),P.bindBuffer(P.PIXEL_PACK_BUFFER,ye),P.getBufferSubData(P.PIXEL_PACK_BUFFER,0,fe),P.deleteBuffer(ye),P.deleteSync(dt),fe}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(x,L=null,k=0){const B=Math.pow(2,-k),z=Math.floor(x.image.width*B),fe=Math.floor(x.image.height*B),xe=L!==null?L.x:0,de=L!==null?L.y:0;g.setTexture2D(x,0),P.copyTexSubImage2D(P.TEXTURE_2D,k,0,0,xe,de,z,fe),ue.unbindTexture()};const El=P.createFramebuffer(),bl=P.createFramebuffer();this.copyTextureToTexture=function(x,L,k=null,B=null,z=0,fe=0){let xe,de,Se,be,Le,Be,ye,tt,dt;const ct=x.isCompressedTexture?x.mipmaps[fe]:x.image;if(k!==null)xe=k.max.x-k.min.x,de=k.max.y-k.min.y,Se=k.isBox3?k.max.z-k.min.z:1,be=k.min.x,Le=k.min.y,Be=k.isBox3?k.min.z:0;else{const ft=Math.pow(2,-z);xe=Math.floor(ct.width*ft),de=Math.floor(ct.height*ft),x.isDataArrayTexture?Se=ct.depth:x.isData3DTexture?Se=Math.floor(ct.depth*ft):Se=1,be=0,Le=0,Be=0}B!==null?(ye=B.x,tt=B.y,dt=B.z):(ye=0,tt=0,dt=0);const nt=C.convert(L.format),Mt=C.convert(L.type);let ge;L.isData3DTexture?(g.setTexture3D(L,0),ge=P.TEXTURE_3D):L.isDataArrayTexture||L.isCompressedArrayTexture?(g.setTexture2DArray(L,0),ge=P.TEXTURE_2D_ARRAY):(g.setTexture2D(L,0),ge=P.TEXTURE_2D),ue.activeTexture(P.TEXTURE0),ue.pixelStorei(P.UNPACK_FLIP_Y_WEBGL,L.flipY),ue.pixelStorei(P.UNPACK_PREMULTIPLY_ALPHA_WEBGL,L.premultiplyAlpha),ue.pixelStorei(P.UNPACK_ALIGNMENT,L.unpackAlignment);const Dt=ue.getParameter(P.UNPACK_ROW_LENGTH),We=ue.getParameter(P.UNPACK_IMAGE_HEIGHT),It=ue.getParameter(P.UNPACK_SKIP_PIXELS),Yt=ue.getParameter(P.UNPACK_SKIP_ROWS),xn=ue.getParameter(P.UNPACK_SKIP_IMAGES);ue.pixelStorei(P.UNPACK_ROW_LENGTH,ct.width),ue.pixelStorei(P.UNPACK_IMAGE_HEIGHT,ct.height),ue.pixelStorei(P.UNPACK_SKIP_PIXELS,be),ue.pixelStorei(P.UNPACK_SKIP_ROWS,Le),ue.pixelStorei(P.UNPACK_SKIP_IMAGES,Be);const Xn=x.isDataArrayTexture||x.isData3DTexture,it=L.isDataArrayTexture||L.isData3DTexture;if(x.isDepthTexture){const ft=S.get(x),vn=S.get(L),rt=S.get(ft.__renderTarget),Sn=S.get(vn.__renderTarget);ue.bindFramebuffer(P.READ_FRAMEBUFFER,rt.__webglFramebuffer),ue.bindFramebuffer(P.DRAW_FRAMEBUFFER,Sn.__webglFramebuffer);for(let jn=0;jn<Se;jn++)Xn&&(P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,S.get(x).__webglTexture,z,Be+jn),P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,S.get(L).__webglTexture,fe,dt+jn)),P.blitFramebuffer(be,Le,xe,de,ye,tt,xe,de,P.DEPTH_BUFFER_BIT,P.NEAREST);ue.bindFramebuffer(P.READ_FRAMEBUFFER,null),ue.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else if(z!==0||x.isRenderTargetTexture||S.has(x)){const ft=S.get(x),vn=S.get(L);ue.bindFramebuffer(P.READ_FRAMEBUFFER,El),ue.bindFramebuffer(P.DRAW_FRAMEBUFFER,bl);for(let rt=0;rt<Se;rt++)Xn?P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,ft.__webglTexture,z,Be+rt):P.framebufferTexture2D(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,ft.__webglTexture,z),it?P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,vn.__webglTexture,fe,dt+rt):P.framebufferTexture2D(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,vn.__webglTexture,fe),z!==0?P.blitFramebuffer(be,Le,xe,de,ye,tt,xe,de,P.COLOR_BUFFER_BIT,P.NEAREST):it?P.copyTexSubImage3D(ge,fe,ye,tt,dt+rt,be,Le,xe,de):P.copyTexSubImage2D(ge,fe,ye,tt,be,Le,xe,de);ue.bindFramebuffer(P.READ_FRAMEBUFFER,null),ue.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else it?x.isDataTexture||x.isData3DTexture?P.texSubImage3D(ge,fe,ye,tt,dt,xe,de,Se,nt,Mt,ct.data):L.isCompressedArrayTexture?P.compressedTexSubImage3D(ge,fe,ye,tt,dt,xe,de,Se,nt,ct.data):P.texSubImage3D(ge,fe,ye,tt,dt,xe,de,Se,nt,Mt,ct):x.isDataTexture?P.texSubImage2D(P.TEXTURE_2D,fe,ye,tt,xe,de,nt,Mt,ct.data):x.isCompressedTexture?P.compressedTexSubImage2D(P.TEXTURE_2D,fe,ye,tt,ct.width,ct.height,nt,ct.data):P.texSubImage2D(P.TEXTURE_2D,fe,ye,tt,xe,de,nt,Mt,ct);ue.pixelStorei(P.UNPACK_ROW_LENGTH,Dt),ue.pixelStorei(P.UNPACK_IMAGE_HEIGHT,We),ue.pixelStorei(P.UNPACK_SKIP_PIXELS,It),ue.pixelStorei(P.UNPACK_SKIP_ROWS,Yt),ue.pixelStorei(P.UNPACK_SKIP_IMAGES,xn),fe===0&&L.generateMipmaps&&P.generateMipmap(ge),ue.unbindTexture()},this.initRenderTarget=function(x){S.get(x).__webglFramebuffer===void 0&&g.setupRenderTarget(x)},this.initTexture=function(x){x.isCubeTexture?g.setTextureCube(x,0):x.isData3DTexture?g.setTexture3D(x,0):x.isDataArrayTexture||x.isCompressedArrayTexture?g.setTexture2DArray(x,0):g.setTexture2D(x,0),ue.unbindTexture()},this.resetState=function(){X=0,W=0,U=null,ue.reset(),se.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Qt}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=Ve._getDrawingBufferColorSpace(e),t.unpackColorSpace=Ve._getUnpackColorSpace()}}const Eg=`
  uniform float uTime;
